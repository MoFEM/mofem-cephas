/** \file LaplaceElement.hpp
 \ingroup mofem_laplace_elem

 \brief Operators and data structures for laplace analysis

 Implementation of laplace element for unsteady and steady case.
 implemented by Xuan Meng
...
#ifndef __LAPLACE_ELEMENT_HPP
#define __LAPLACE_ELEMENT_HPP

namespace MoFEM {

/** \brief structure grouping operators and data used for laplace problems
  * \ingroup mofem_laplace_elem
  *
...
struct LaplaceElement {
  ...
  /** \brief define surface element
    *
    * This element is used to integrate fluxes
    */
  ...
  /** \brief data for calculation velocity flux vector
    * \infroup mofem_laplace_elem
    */
  struct FluxData {
    ublas::vector<double> flux; ///< for more details look to BCMultiIndices.hpp to see details of HeatfluxCubitBcData
  ...
  /** \brief common data used by volume elements
    ...
    */
  struct CommonData {
    ublas::vector<double> potentialAtGaussPts;
    ublas::vector<double> potentialRateAtGaussPts;
  ...
  /// \brief operator to calculate potential gradient at Gauss points
  struct OpGetGradAtGaussPts: public VolumeElementForcesAndSourcesCore::UserDataOperator {
    ...
    /** \brief operator calculating potential gradients
      *
      * potential gradient is calculated multiplying derivatives of shape functions by degrees of freedom.
      */
  ...
  /** \brief operator to calculate potential  and rate of temperature at Gauss points
    * \infroup mofem_laplace_elem
    */
  ...
  /** \biref operator to calculate right hand side of heat conductivity terms
    * \infroup mofem_laplace_elem
    */
  struct OpLaplaceRhs: public VolumeElementForcesAndSourcesCore::UserDataOperator {

    BlockData &dAta;
    CommonData &commonData;
    bool useTsF;
    OpLaplaceRhs(const string field_name,BlockData &data,CommonData &common_data):
      VolumeElementForcesAndSourcesCore::UserDataOperator(field_name,UserDataOperator::OPROW),
      dAta(data),commonData(common_data),useTsF(true) {}

    Vec F;
    OpLaplaceRhs(const string field_name,Vec _F,BlockData &data,CommonData &common_data):
      VolumeElementForcesAndSourcesCore::UserDataOperator(field_name,UserDataOperator::OPROW),
      dAta(data),commonData(common_data),useTsF(false),F(_F) { }

    ublas::vector<double> Nf;

    /** \brief calculate laplace conductivity matrix
      *
  ...
  /** \biref operator to calculate left hand side of heat conductivity terms
    * \infroup mofem_laplace_elem
    */
  struct OpLaplaceLhs: public VolumeElementForcesAndSourcesCore::UserDataOperator {

    BlockData &dAta;
    CommonData &commonData;
    bool useTsB;
    OpLaplaceLhs(const string field_name,BlockData &data,CommonData &common_data):
    ...
    Mat A;
    OpLaplaceLhs(const string field_name,Mat _A,BlockData &data,CommonData &common_data):
      VolumeElementForcesAndSourcesCore::UserDataOperator(field_name,UserDataOperator::OPROWCOL),
  ...
  struct OpRadiationLhs:public FaceElementForcesAndSourcesCore::UserDataOperator {
    ...
    /** \brief calculate laplace radiation term in the lhs of equations(Tangent Matrix) for transient Laplace Problem
      *
  ...
  struct OpConvectionLhs:public FaceElementForcesAndSourcesCore::UserDataOperator {
    ...
    ublas::matrix<double> K,transK;
    /** \brief calculate laplace convection term in the lhs of equations
     *
  ...
  /** \brief add laplace element on tets
    * \infroup mofem_laplace_elem
    *
    ...
    */
  PetscErrorCode addLaplaceElements(const string field_name,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");
  ...
  /** \brief add heat flux element
    ...
    * \param name of mesh nodal positions (if not defined nodal coordinates are used)
    */
  PetscErrorCode addLaplaceFluxElement(const string field_name,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");
  ...
  * \param name of mesh nodal positions (if not defined nodal coordinates are used)
  */
  PetscErrorCode addLaplaceConvectionElement(const string field_name,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");
  ...
  * \param name of mesh nodal positions (if not defined nodal coordinates are used)
  */
  PetscErrorCode addLaplaceRadiationElement(const string field_name,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");

  /** \brief this function is used in case of stationary problem to set elements for rhs
    * \infroup mofem_laplace_elem
    */
  PetscErrorCode setLaplaceFiniteElementRhsOperators(string field_name,Vec &F);

  /** \brief this function is used in case of stationary heat conductivity problem for lhs
    * \infroup mofem_laplace_elem
    */
  PetscErrorCode setLaplaceFiniteElementLhsOperators(string field_name,Mat A);

  /** \brief this function is used in case of stationary problem for heat flux terms
    * \infroup mofem_laplace_elem
    */
  PetscErrorCode setLaplaceFluxFiniteElementRhsOperators(string field_name,Vec &F,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");

  /* \brief linear Steady convection terms in lhs
   */
  PetscErrorCode setLaplaceConvectionFiniteElementRhsOperators(string field_name,Vec &F,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");

  /* \brief linear Steady convection terms in rhs
   */
  PetscErrorCode setLaplaceConvectionFiniteElementLhsOperators(string field_name,Mat A,const string mesh_nodals_positions = "MESH_NODE_POSITIONS");
...
#endif //__laplace_ELEMENT_HPP

/***************************************************************************//**
 * \defgroup mofem_laplace_elem Laplace element
