...
////  MAT_HELMHOLTZSET = 1<<17,    ///block name is "MAT_HELMHOLTZ"
////  MAT_MOISTURESET = 1<<18, ///< block name is "MAT_MOISTURE"
////  LASTCUBITSET
////};
...
//  /*! \brief Print Mat_Thermal data
//  */
//  friend ostream& operator<<(ostream& os,const Mat_Thermal& e);
//};

///*! \struct Mat_Helmholtz
//*  \brief Helmholtz material data structure
//*/
//struct Mat_Helmholtz: public GenericAttributeData {
//  struct __attribute__ ((packed)) _data_{
//    double AngularFreq; // Angular Frequency
//    double Speed; // Helmholtz sound speed
//    double User2; // User attribute 2
//    double User3; // User attribute 3
//    double User4; // User attribute 4
//    double User5; // User attribute 5
...
//  const CubitBC_BitSet type;
//  const unsigned int min_number_of_atributes;
//  Mat_Helmholtz(): type(MAT_HELMHOLTZSET),min_number_of_atributes(2) {};

//  virtual PetscErrorCode fill_data(const vector<double>& attributes) {
//    PetscFunctionBegin;
//    if(attributes.size()<min_number_of_atributes) {
//      SETERRQ(PETSC_COMM_SELF,1,"Helmholtz Angular Frequency is not defined. (top tip: check number of HELMHOLTZ block atributes)");
//    }
//    if(8*attributes.size()>sizeof(data)) {
//      SETERRQ(PETSC_COMM_SELF,1,"data inconsistency, please review the number of material properties defined");
//    }
...
//  }
//  
//  /*! \brief Print Mat_Helmholtz data
//  */
//  friend ostream& operator<<(ostream& os,const Mat_Helmholtz& e);
//};
