...
struct NormElement {
	...
	struct CommonData {
		...
		ublas::matrix<double> gradFieldValue1AtGaussPts;
		...
		inline ublas::matrix_row<ublas::matrix<double> > getGradField1AtGaussPts(const int gg) {
			return ublas::matrix_row<ublas::matrix<double> >(gradFieldValue1AtGaussPts,gg);
    ...
    */
	struct OpGetTetField1AtGaussPts: public OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore> {
		OpGetTetFieldAtGaussPts(const string field_name,CommonData &common_data):
			OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore>(field_name,common_data.Field1AtGaussPts) {}
	};
	
	struct OpGetTetFiel2dAtGaussPts: public OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore> {
		OpGetTetFieldAtGaussPts(const string field_name,CommonData &common_data):
			OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore>(field_name,common_data.Field2AtGaussPts) {}
	};
	...
	struct OpGetTriFieldAtGaussPts: public OpGetFieldAtGaussPts<TriElementForcesAndSurcesCore> {
		OpGetTriFieldAtGaussPts(const string field_name,CommonData &common_data):
			OpGetFieldAtGaussPts<TriElementForcesAndSurcesCore>(field_name,common_data.FieldAtGaussPts) {}
	};
	...
	struct OpGetTetFieldRateAtGaussPts: public OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore> {
		OpGetTetFieldRateAtGaussPts(const string field_name,CommonData &common_data):
			OpGetFieldAtGaussPts<TetElementForcesAndSourcesCore>(field_name,common_data.FieldRateAtGaussPts) {}
	};
			...
			try {
				...
				for(unsigned int gg = 0;gg<data.getN().size1();gg++) {
                   ...
                   //		
					...
					eRror = uAnaly - uNumer;
					double sqGradError = prod((commonData.getField1GradAtGaussPts(gg)-commonData.getField2GradAtGaussPts(gg)),(commonData.getField1GradAtGaussPts(gg)-commonData.getField2GradAtGaussPts(gg)));
					sqError = sqGradError + pow(eRror(gg),2.0);
					}
