...
//      if(count%10==0){
      if(count==100){
        ...
        ElasticFEMethod_Dmat_input* my_fe_ptr = new ElasticFEMethod_Dmat_input(m_field_Macro,A,D,Fint,0.0,0.0,calculate_rve_dmat_transiso_periodic.commonData.Dmat_RVE,"DISP_MACRO");
        //preproc
