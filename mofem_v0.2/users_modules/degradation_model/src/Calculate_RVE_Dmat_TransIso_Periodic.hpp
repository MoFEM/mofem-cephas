...
#ifndef __CALCULATE_RVE_DMAT_TRANSISO_PERIODIC_HPP
#define __CALCULATE_RVE_DMAT_TRANSISO_PERIODIC_HPP

namespace MoFEM {

  struct Calculate_RVE_Dmat_TransIso_Periodic {
    ...
    Calculate_RVE_Dmat_TransIso_Periodic(FieldInterface &m_field):
    feRhs(m_field),
    mField(m_field) {}
...
//              cout<<"gg Start =  "<<gg <<endl;
              ...
              ElasticFE_RVELagrange_Periodic_Multi_Rhs MyFE_RVELagrange(m_field_RVE,A,D1,F1,F2,F3,F4,F5,F6,applied_strain,"DISP_RVE","Lagrange_mul_disp",field_rank);
              ElasticFE_RVELagrange_RigidBodyTranslation MyFE_RVELagrangeRigidBodyTrans(m_field_RVE,A,D1,F1,applied_strain,"DISP_RVE","Lagrange_mul_disp",field_rank,"Lagrange_mul_disp_rigid_trans");
...
//              ierr = VecView(D1,PETSC_VIEWER_STDOUT_WORLD); CHKERRQ(ierr);
...

              {
                ...
                ElasticFE_RVELagrange_Homogenized_Stress_Periodic MyFE_RVEHomoStressPeriodic(m_field_RVE,A,D1,F1,&RVE_volume, applied_strain, Stress_Homo,"DISP_RVE","Lagrange_mul_disp",field_rank);
...
#endif //__CALCULATE_RVE_DMAT_TRANSISO_PERIODIC_HPP
