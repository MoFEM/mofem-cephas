...
#ifndef __CALCULATE_WT_ONLYTEMP_HPP
#define __CALCULATE_WT_ONLYTEMP_HPP

namespace MoFEM {
  
  
  struct Calculate_wt_onlyTemp {
    ...
    Calculate_wt_onlyTemp(FieldInterface &m_field): feRhsDegradation(m_field), feLhsDegradation(m_field), mField(m_field) {}
...
//            cout << "dAta.refTemperature "<<dAta.saturation_Conc<< endl;
            ...
            double Nf1=qw_dot+beta*log(1-T/Tg)*qw;
      ...
      PetscErrorCode doWork(
        ...
        try {
          ...
          for(unsigned int gg = 0;gg<row_data.getN().size1();gg++) {
            ...
            val *=beta*log(1-T/Tg)+getFEMethod()->ts_a;
