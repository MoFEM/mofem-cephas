...
#ifndef __CALCULATE_RVE_DMAT_TRANSISO_HPP
#define __CALCULATE_RVE_DMAT_TRANSISO_HPP

namespace MoFEM {

  struct Calculate_RVE_Dmat_TransIso {
    ...
    Calculate_RVE_Dmat_TransIso(FieldInterface &m_field):
    feRhs(m_field),
    mField(m_field) {}
...
#endif //__CALCULATE_RVE_DMAT_TRANSISO_HPP
