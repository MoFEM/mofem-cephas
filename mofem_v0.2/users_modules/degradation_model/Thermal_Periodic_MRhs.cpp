...
//  //C row as Lagrange_mul_disp and col as TEMP
//============================================================================================================
  ...
  //CT col as Lagrange_mul_disp and row as TEMP
...
//============================================================================================================
  ...
  ierr = mField.modify_finite_element_add_field_col("LAGRANGE_FE_rigid_trans","TEMP"); CHKERRQ(ierr);
  ...
  ierr = mField.modify_finite_element_add_field_row("LAGRANGE_FE_rigid_trans","TEMP"); CHKERRQ(ierr);
  
  //Data
  ierr = mField.modify_finite_element_add_field_data("LAGRANGE_FE_rigid_trans","LAGRANGE_MUL_FIELD_rigid_trans"); CHKERRQ(ierr);
  ierr = mField.modify_finite_element_add_field_data("LAGRANGE_FE_rigid_trans","TEMP"); CHKERRQ(ierr);
  //============================================================================================================
  
  //set finite elements for problem
  ierr = mField.modify_problem_add_finite_element("THERMAL_PROBLEM","LAGRANGE_FE"); CHKERRQ(ierr);
  ierr = mField.modify_problem_add_finite_element("THERMAL_PROBLEM","LAGRANGE_FE_rigid_trans"); CHKERRQ(ierr);
...
//
  ...
  ElasticFE_RVELagrange_Periodic_Multi_Rhs MyFE_RVELagrange(mField,A,C1,F1,F2,F3,applied_strain,"TEMP","LAGRANGE_MUL_FIELD",field_rank);
  ElasticFE_RVELagrange_RigidBodyTranslation MyFE_RVELagrangeRigidBodyTrans(mField,A,C1,F1,applied_strain,"TEMP","LAGRANGE_MUL_FIELD",field_rank,"LAGRANGE_MUL_FIELD_rigid_trans");
  ...
  ierr = mField.loop_finite_elements("THERMAL_PROBLEM","LAGRANGE_FE_rigid_trans",MyFE_RVELagrangeRigidBodyTrans);  CHKERRQ(ierr);
...
//=============================================================================================================
...

  {
    ...
    ElasticFE_RVELagrange_Homogenized_Stress_Periodic MyFE_RVEHomoStressPeriodic(mField,A,C1,F1,&RVE_volume, applied_strain, Stress_Homo,"TEMP","LAGRANGE_MUL_FIELD",field_rank);
    ierr = mField.loop_finite_elements("THERMAL_PROBLEM","LAGRANGE_FE",MyFE_RVEHomoStressPeriodic);  CHKERRQ(ierr);
  ...
  {
    ierr = VecZeroEntries(Stress_Homo); CHKERRQ(ierr);
    ElasticFE_RVELagrange_Homogenized_Stress_Periodic MyFE_RVEHomoStressPeriodic(mField,A,C1,F3,&RVE_volume, applied_strain, Stress_Homo,"TEMP","LAGRANGE_MUL_FIELD",field_rank);
    ierr = mField.loop_finite_elements("THERMAL_PROBLEM","LAGRANGE_FE",MyFE_RVEHomoStressPeriodic);  CHKERRQ(ierr);
    VecGhostUpdateBegin(Stress_Homo,INSERT_VALUES,SCATTER_FORWARD);
    VecGhostUpdateEnd(Stress_Homo,INSERT_VALUES,SCATTER_FORWARD);
    PetscScalar *avec;
