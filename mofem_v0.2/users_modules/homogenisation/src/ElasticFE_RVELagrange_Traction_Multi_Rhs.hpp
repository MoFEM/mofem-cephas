...
#ifndef __ELASTICFE_RVELAGRANGE_TRACTION_MULTI_RHS_HPP__
#define __ELASTICFE_RVELAGRANGE_TRACTION_MULTI_RHS_HPP__
...
namespace MoFEM {
  ...
  struct ElasticFE_RVELagrange_Traction_Multi_Rhs: public ElasticFE_RVELagrange_Traction {
    ...
    ElasticFE_RVELagrange_Traction_Multi_Rhs(
    ...
    ElasticFE_RVELagrange_Traction(_mField,_Aij, _D, _F1, _applied_strain, _field_main, _field_lagrange, _rank_field),F1(_F1),F2(_F2),F3(_F3),F4(_F4),F5(_F5),F6(_F6){};
    ...
    ElasticFE_RVELagrange_Traction(_mField,_Aij, _D, _F1, _applied_strain, _field_main, _field_lagrange, _rank_field),F1(_F1),F2(_F2),F3(_F3){};
...
#endif //__ElasticFE_RVELagrange_Traction_MULTI_RHS_HPP__
