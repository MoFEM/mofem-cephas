...
//#include <RVE_Dmat_TransIso_Disp.hpp>
...
int main(int argc, char *argv[]) {
 ...
 // ierr = PetscOptionsGetString(PETSC_NULL,"-my_out",outName,sizeof(outName),&flg); CHKERRQ(ierr);
  ...
  //RVE_Dmat_TransIso_Disp calculate_rve_Dmat;
  //ierr = calculate_rve_Dmat.OpCalculate_RVEDmat(m_field_RVE,"DISP_RVE"); CHKERRQ(ierr);
  //OpCalculate_RVEDmat(m_field_RVE,"DISP_RVE");
 ...
 //***************************************************************************
  ...
  MyElasticFEMethod_Macro my_fe_Macro(m_field_Macro,A,D,F,Dnmat,"DISP_MACRO");
  ...
  FE2_PostProcStressForReliability_Zeroth Calc_Stress(m_field_Macro,"DISP_MACRO",Dnmat);
