...
namespace MoFEM {
  ...
  struct LimitStateFunction {
    ...
    virtual PetscErrorCode gfun_ply_TW(ublas::vector<double> x,//ublas::matrix<double> PlyStrength,
      ...
      F44 = 1/(S_23*S_23);
      F66 = 1/(S_12*S_12);
      cout<<"X_T "<<X_T<<" X_C "<<X_C<<" Y_T "<<Y_T<<" Y_C "<<Y_C<<" S_12 "<<S_12<<endl;
      cout<<setprecision(15)<<1/sqrt(X_T*X_C*Y_T*Y_C)<<endl;
      //StressGP = StressGP;
      // Evaluate the limit state function
      cout<<"F1*StressGP(0,0): "<<F1*StressGP(0,0)<<endl;
      cout<<"F2*(StressGP(1,1) + StressGP(2,2)): "<<F2*(StressGP(1,1) + StressGP(2,2))<<endl;
      cout<<"F11*StressGP(0,0)*StressGP(0,0): "<<F11*StressGP(0,0)*StressGP(0,0)<<endl;
      cout<<"F22*pow((StressGP(1,1) + StressGP(2,2)),2): "<<F22*pow((StressGP(1,1) + StressGP(2,2)),2)<<endl;
      cout<<"F44*(StressGP(1,2)*StressGP(1,2) - StressGP(1,1)*StressGP(2,2)): "<<F44*(StressGP(1,2)*StressGP(1,2) - StressGP(1,1)*StressGP(2,2))<<endl;
      cout<<"F66*(StressGP(0,1)*StressGP(0,1) + StressGP(2,0)*StressGP(2,0)): "<<F66*(StressGP(0,1)*StressGP(0,1) + StressGP(2,0)*StressGP(2,0))<<endl;
      cout<<"F12*StressGP(0,0)*(StressGP(1,1)+StressGP(2,2))): "<<setprecision(15)<<F12<<"  "<<F12*StressGP(0,0)*(StressGP(1,1)+StressGP(2,2))<<endl;
    ...
    virtual PetscErrorCode gfun_ply_TH(ublas::matrix<double> PlyStrength,
                                                    ublas::matrix<double> StressGP,
                                                    ublas::matrix<double> StressGP_r_Em,
                                                    ublas::matrix<double> StressGP_r_NUm,
                                                    ublas::matrix<double> StressGP_r_NUp,
      ...
      // w.r.t. Em
      dsdx.clear(); dsdx = StressGP_r_Em;
      grad_lsf(0) = - (2*StressGP(0,0)*StressGP_r_Em(0,0)/(X*X)
      ...
      // w.r.t. NUm
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_NUm;
      grad_lsf(1) = - (2*StressGP(0,0)*StressGP_r_NUm(0,0)/(X*X)
      ...
      // w.r.t. NUp
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_NUp;
      grad_lsf(2) = - (2*StressGP(0,0)*StressGP_r_NUp(0,0)/(X*X)
      ...
      // w.r.t. NUpz
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_NUpz;
      grad_lsf(3) = - (2*StressGP(0,0)*StressGP_r_NUpz(0,0)/(X*X)
      ...
      // w.r.t. Ep
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_Ep;
      grad_lsf(4) = - (2*StressGP(0,0)*StressGP_r_Ep(0,0)/(X*X)
      ...
      // w.r.t. Ez
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_Ez;
      grad_lsf(5) = - (2*StressGP(0,0)*StressGP_r_Ez(0,0)/(X*X)
      ...
      // w.r.t. Gzp
      dsdx.clear(); dsdx.resize(3,3); dsdx = StressGP_r_Gzp;
      grad_lsf(6) = - (2*StressGP(0,0)*StressGP_r_Gzp(0,0)/(X*X)
