...
//                                                                Dmat_rs(ivar,jvar));
        ...
        // cout<<"\nDmat_rs: \n"<< Dmat_rs(ivar,jvar) <<endl;
        // cout<<"\nStress_rs at GP in xyz space:\n"<<Calc_Stress_2nd.StressGP_rs<<endl;
    ...
    // cout<<"\nHessian matrix in u: "<<Hess_G<<endl;
    // cout<<"\nHessian matrix in x: "<<Hess_g<<endl;
    
    // =======================================
    //
    // 9.7 Calculate the main curvatures
    //
    // =======================================
    ...
    double pf_Breitung = cdf(snorm,-beta);
    for (int i = 0; i<Size_A; i++) {
