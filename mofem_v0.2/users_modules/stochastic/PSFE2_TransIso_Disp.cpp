...
int main(int argc, char *argv[]) {
 ...
 //***************************************************************************
  ...
  ublas::matrix<double> Dmat_r_Em, Dmat_r_NUm, Dmat_r_Ep, Dmat_r_Ez, Dmat_r_NUp, Dmat_r_NUpz, Dmat_r_Gzp;
  
  ublas::matrix<double> Dmat_rs_EmEm, Dmat_rs_NUmNUm, Dmat_rs_EpEp, Dmat_rs_EzEz, Dmat_rs_NUpNUp, Dmat_rs_NUpzNUpz, Dmat_rs_GzpGzp;
  ...
  Dmat_r_Em        = Solve_FE2_Problem.Dmat_r_Em;
  ...
  Dmat_rs_GzpGzp   = Solve_FE2_Problem.Dmat_rs_GzpGzp;
