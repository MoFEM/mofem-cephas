...
struct Gel {
  ...
  */
  struct ConstitutiveEquation {
    ...
    */
    PetscErrorCode calcualteStressAlpha() {
      PetscFunctionBegin;
    ...
    */
    PetscErrorCode calcualteStressBeta() {
      PetscFunctionBegin;
    ...
    */
    PetscErrorCode calcualteStrainHatDot() {
      PetscFunctionBegin;
    ...
    */
    PetscErrorCode calcualteStressBetaHat() {
      PetscFunctionBegin;
  ...
  struct OpJacobian: public VolumeElementForcesAndSourcesCore::UserDataOperator {
    ...
    PetscErrorCode recordStressTotal() {
      ...
      trace_on(tagS[STRESSTOTAL]);
      {
        ...
        // Do calculations
        ierr = cE.calcualteStressAlpha(); CHKERRQ(ierr);
        ierr = cE.calcualteStressBeta(); CHKERRQ(ierr);
        ierr = cE.calcualteStressBetaHat(); CHKERRQ(ierr);
