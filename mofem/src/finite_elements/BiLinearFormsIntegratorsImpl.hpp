/** \file BiLinearFormsIntegratorsImpl.hpp
...
#ifndef __BILINEAR_FORMS_INTEGRATORS_IMPL_HPP__
#define __BILINEAR_FORMS_INTEGRATORS_IMPL_HPP__
...
#endif //__BILINEAR_FORMS_INTEGRATORS_IMPL_HPP__