/** \file LinearFormsIntegratorsImpl.hpp
  * \brief Linear forms integrators (implementation)
  * \ingroup mofem_form

*/

#ifndef __LINEAR_FORMS_INTEGRATORS_IMPL_HPP__
#define __LINEAR_FORMS_INTEGRATORS_IMPL_HPP__
...
template <int SPACE_DIM, typename OpBase>
MoFEMErrorCode
OpNormalMixVecTimesVectorFieldImpl<SPACE_DIM, GAUSS, OpBase>::iNtegrate(
    EntitiesFieldData::EntData &row_data) {
  MoFEMFunctionBegin;
  FTensor::Index<'i', 3> i;
  FTensor::Index<'J', SPACE_DIM> J;
