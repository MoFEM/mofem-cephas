...
class Tensor4_times_Tensor1_3
{
  ...
  typename promote<T,U>::V eval(
    const int N1, const int N2,const int N3,const Number<Current_Dim> &
  )  const {
    return
    iterA(N1,N2,N3,Current_Dim-1)*iterB(Current_Dim-1)
    + eval(N1,N2,N3,Number<Current_Dim-1>());
  }
  typename promote<T,U>::V eval(
    const int N1, const int N2,const int N3, const Number<1> &
  )  const {
...
public:
  ...
  (const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
   const Tensor1_Expr<B,U,Dim3,l> &b): iterA(a), iterB(b) {}
};

template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
  int Dim3, char i, char j, char k, char l>
inline Tensor3_Expr
<const Tensor4_times_Tensor1_3<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
  typename promote<T,U>::V,Dim0,Dim1,Dim2,i,j,k>
operator*(
  const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
	const Tensor1_Expr<B,U,Dim3,l> &b
) {
  typedef const Tensor4_times_Tensor1_3
    <A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> TensorExpr;
  return
  Tensor3_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,i,j,k>
  (TensorExpr(a,b));
}
...
class Tensor4_times_Tensor1_2
{
  ...
  typename promote<T,U>::V eval(
    ...
    return
    iterA(N1,N2,Current_Dim-1,N3)*iterB(Current_Dim-1)
    + eval(N1,N2,N3,Number<Current_Dim-1>());
  }
  typename promote<T,U>::V eval(
    const int N1, const int N2,const int N3, const Number<1> &
...
public:
  ...
  (const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
   const Tensor1_Expr<B,U,Dim2,k> &b): iterA(a), iterB(b) {}
};

template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
  int Dim3, char i, char j, char k, char l>
inline Tensor3_Expr
<const Tensor4_times_Tensor1_2<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
  typename promote<T,U>::V,Dim0,Dim1,Dim3,i,j,l>
operator*(
  const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
	const Tensor1_Expr<B,U,Dim2,k> &b
) {
  typedef const Tensor4_times_Tensor1_2
    <A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> TensorExpr;
  return
  Tensor3_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim3,i,j,l>
  (TensorExpr(a,b));
}
...
class Tensor4_times_Tensor1_1
{
  ...
  typename promote<T,U>::V eval(
    ...
    return
    iterA(N1,Current_Dim-1,N2,N3)*iterB(Current_Dim-1)
    + eval(N1,N2,N3,Number<Current_Dim-1>());
  }
  typename promote<T,U>::V eval(
    const int N1, const int N2,const int N3, const Number<1> &
...
template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
  int Dim3, char i, char j, char k, char l>
inline Tensor3_Expr
<const Tensor4_times_Tensor1_1<A,B,T,U,Dim0,Dim2,Dim2,Dim3,i,j,k,l>,
  typename promote<T,U>::V,Dim0,Dim1,Dim3,i,k,l>
operator*(
  const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
	const Tensor1_Expr<B,U,Dim1,j> &b
) {
  typedef const Tensor4_times_Tensor1_1
    <A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> TensorExpr;
  return
  Tensor3_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim2,Dim3,i,k,l>
  (TensorExpr(a,b));
}
...
template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
  int Dim3, char i, char j, char k, char l>
inline Tensor3_Expr
<const Tensor4_times_Tensor1_1<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
...
class Tensor4_times_Tensor1_0
{
  ...
  typename promote<T,U>::V eval(
    ...
    return
    iterA(Current_Dim-1,N1,N2,N3)*iterB(Current_Dim-1)
    + eval(N1,N2,N3,Number<Current_Dim-1>());
  }
  typename promote<T,U>::V eval(
    const int N1, const int N2,const int N3, const Number<1> &
...
public:
  ...
  (const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
   const Tensor1_Expr<B,U,Dim0,i> &b): iterA(a), iterB(b) {}
};

template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
  int Dim3, char i, char j, char k, char l>
inline Tensor3_Expr
<const Tensor4_times_Tensor1_0<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
  typename promote<T,U>::V,Dim1,Dim2,Dim3,j,k,l>
operator*(
  const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
	const Tensor1_Expr<B,U,Dim0,i> &b
) {
  typedef const Tensor4_times_Tensor1_0
    <A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> TensorExpr;
  return
