...
namespace FTensor
{
  ...
  public:
    ...
    Tensor4_minus_Tensor4(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
  ...
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &b)
  {
    typedef const Tensor4_minus_Tensor4<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
  ...
  template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
          int Dim3, char i, char j, char k, char l>
  inline Tensor4_Expr
          <const Tensor4_minus_Tensor4_0312<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
                  typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim0,Dim3,Dim1,Dim2,i,l,j,k> &b)
  {
    typedef const Tensor4_minus_Tensor4_0312<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
    return Tensor4_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            (TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
          int Dim3, char i, char j, char k, char l>
  inline Tensor4_Expr
          <const Tensor4_minus_Tensor4_0321<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
                  typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim0,Dim3,Dim2,Dim1,i,l,k,j> &b)
  {
    typedef const Tensor4_minus_Tensor4_0321<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
    return Tensor4_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            (TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
          int Dim3, char i, char j, char k, char l>
  inline Tensor4_Expr
          <const Tensor4_minus_Tensor4_0213<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
                  typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim0,Dim2,Dim1,Dim3,i,k,j,l> &b)
  {
    typedef const Tensor4_minus_Tensor4_0213<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
    return Tensor4_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            (TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
          int Dim3, char i, char j, char k, char l>
  inline Tensor4_Expr
          <const Tensor4_minus_Tensor4_3201<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
                  typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim3,Dim2,Dim0,Dim1,l,k,i,j> &b)
  {
    typedef const Tensor4_minus_Tensor4_3201<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
    return Tensor4_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            (TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
          int Dim3, char i, char j, char k, char l>
  inline Tensor4_Expr
          <const Tensor4_minus_Tensor4_0132<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,
                  typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
  operator-(const Tensor4_Expr<A,T,Dim0,Dim1,Dim2,Dim3,i,j,k,l> &a,
            const Tensor4_Expr<B,U,Dim0,Dim1,Dim3,Dim2,i,j,l,k> &b)
  {
    typedef const Tensor4_minus_Tensor4_0132<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            TensorExpr;
    return Tensor4_Expr<TensorExpr,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
            (TensorExpr(a,b));
  }
