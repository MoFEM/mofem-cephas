...
namespace FTensor
{
  ...
  operator*(const Tensor4_Expr<A, T, Dim0, Dim1, Dim2, Dim3, i, j, k, l> &a,
    ...
    typedef const Tensor4_times_Tensor2_1_1<A, B, T, U, Dim0, Dim1, Dim2, Dim3,
                                            Dim4, i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim4, Dim2,
                        Dim3, i, m, k, l>(TensorExpr(a, b));
  }
  ...
  operator*(const Tensor4_Expr<A, T, Dim0, Dim1, Dim2, Dim3, i, j, k, l> &a,
    ...
    typedef const Tensor4_times_Tensor2_0_0<A, B, T, U, Dim0, Dim1, Dim2, Dim3,
                                            Dim4, i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim4, Dim1, Dim2,
                        Dim3, m, j, k, l>(TensorExpr(a, b));
  }
