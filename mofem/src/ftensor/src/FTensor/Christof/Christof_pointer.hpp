...
namespace FTensor
{
  ...
  public:
    ...
    {
      Christof_constructor<T* restrict,Tensor_Dim0,Tensor_Dim12>
    ...
    {
      return Dg_Expr<Christof<T*,Tensor_Dim0,Tensor_Dim12>,
    ...
    inline Tensor1_Expr<const Tensor3_contracted_12
                        <const Christof<T*,Tensor_Dim0,Tensor_Dim12>,T,Dim12>,T,Dim0,i>
    ...
    Tensor2_symmetric_Expr<const Christof_number_0
                           <const Christof<T*,Tensor_Dim0,Tensor_Dim12>,T,N>,T,Dim12,i,j>
    ...
    Tensor2_Expr<const Christof_numeral_1
                 <const Christof<T*,Tensor_Dim0,Tensor_Dim12>,T>,T,Dim0,Dim2,i,j>
