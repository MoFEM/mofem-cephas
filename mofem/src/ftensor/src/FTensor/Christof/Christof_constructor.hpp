...
namespace FTensor
{
  ...
  {
  public:
    Christof_constructor(T data[2][3], T d000, T d100, T d001, T d101,
                                 T d011, T d111)
    {
      data[0][0]=d000;
      data[1][0]=d100;
  ...
  {
  public:
    Christof_constructor(T data[4][10], T d000, T d100, T d200, T d300,
  ...
  {
  public:
    Christof_constructor(T data[3][10], T d000, T d100, T d200,
