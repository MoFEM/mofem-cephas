...
namespace FTensor
{
  ...
  public:
    ...
    Christof(T d000, T d100, T d200, T d001, T d101, T d201,
    ...
    Christof(T d000, T d100, T d200, T d300,
    ...
    typename std::enable_if<(Tensor_Dim0 >= Dim0 && Tensor_Dim12 >= Dim12),
            Dg_Expr<Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T,Dim12,Dim0,i,j,k> >::type
    operator()
    (const Index<k,Dim0> , const Index<i,Dim12> ,
     const Index<j,Dim12> )
    {
      return Dg_Expr<Christof<T,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k>(*this);
    }
    ...
    {
      return Dg_Expr<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
    ...
    typename std::enable_if<(Tensor_Dim0 >= Dim && Tensor_Dim12 > N1 && Tensor_Dim12 > N2),
            Tensor1_Expr<Dg_number_rhs_12<Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T,N1,N2>,T,Dim,i> >::type
    operator()(const Index<i,Dim> , const Number<N1> ,
               const Number<N2> )
    {
      typedef Dg_number_rhs_12<Christof<T,Tensor_Dim0,
                                                        Tensor_Dim12>,
                                       T,N1,N2> TensorExpr;
    ...
    template<char i, int N1, int N2, int Dim>
    typename std::enable_if<(Tensor_Dim0 >= Dim && Tensor_Dim12 > N1 && Tensor_Dim12 > N2),
            const Tensor1_Expr<const Dg_number_12<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
                       T,N1,N2>,T,Dim,i> >::type
    operator()(const Index<i,Dim> , const Number<N1> ,
               const Number<N2> ) const
    {
      typedef const Dg_number_12<const Christof
    ...
    inline
    typename std::enable_if<(Tensor_Dim0 >= Dim0 && Tensor_Dim12 >= Dim12),
            Tensor1_Expr<const Tensor3_contracted_12<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
    ...
    typename std::enable_if<(Tensor_Dim0 >= Dim && Tensor_Dim12 >= Dim),
            Tensor1_Expr<const Tensor3_contracted_02<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T,Dim>,T,Dim,i> >::type
    ...
    inline
    typename std::enable_if<(Tensor_Dim0 >= Dim && Tensor_Dim12 >= Dim),
            Tensor1_Expr<const Tensor3_contracted_01<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T,Dim>,T,Dim,i> >::type
    ...
    typename std::enable_if<(Tensor_Dim0 > N && Tensor_Dim12 >= Dim12),
            Tensor2_symmetric_Expr<const Christof_number_0<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T,N>,T,Dim12,i,j> >::type
    operator()(const Number<N> , const Index<i,Dim12> ,
               const Index<j,Dim12> ) const
    {
      typedef const Christof_number_0
        <const Christof<T,Tensor_Dim0,Tensor_Dim12>,T,N> TensorExpr;
    ...
    typename std::enable_if<(Tensor_Dim12 >= Dim12),
            Tensor2_symmetric_Expr<const Christof_numeral_0<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
                 T>,T,Dim12,i,j> >::type
    operator()(const int N, const Index<i,Dim12> ,
               const Index<j,Dim12> ) const
    {
      typedef const Christof_numeral_0
        <const Christof<T,Tensor_Dim0,Tensor_Dim12>,T> TensorExpr;
    ...
    typename std::enable_if<(Tensor_Dim0 >= Dim0 && Tensor_Dim12 >= Dim2),
            Tensor2_Expr<const Christof_numeral_1<const Christof<T,Tensor_Dim0,Tensor_Dim12>,T>,
    ...
    template<char i, char j, int Dim0, int Dim2>
    typename std::enable_if<(Tensor_Dim0 >= Dim0 && Tensor_Dim12 >= Dim2),
            Tensor2_Expr<const Christof_numeral_1<const Christof<T,Tensor_Dim0,Tensor_Dim12>,
