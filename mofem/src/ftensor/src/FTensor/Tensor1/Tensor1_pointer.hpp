...
public:
  ...
  Tensor1(T *d0, T *d1, T *d2, T *d3, T *d4, T *d5, T *d6, T *d7, const int i = 1) : inc(i) {
    Tensor1_constructor<T * restrict, Tensor_Dim>(data, d0, d1, d2, d3, d4, d5, d6, d7);
  }
  Tensor1(T *d0, T *d1, T *d2, T *d3, T *d4, T *d5, T *d6, T *d7, T *d8, const int i = 1) : inc(i) {
    Tensor1_constructor<T * restrict, Tensor_Dim>(data, d0, d1, d2, d3, d4, d5, d6, d7, d8);
  }
