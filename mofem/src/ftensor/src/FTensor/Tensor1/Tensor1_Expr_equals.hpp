...
namespace FTensor
{
  ...
  template <class A, class B, class U, int Dim, char i, int Current_Dim>
  inline void T1_equals_addolc_left_T1(A &iter,
  ...
  template <class A, class B, class U, int Dim, char i, int Current_Dim>
  inline void T1_equals_addolc_right_T1(A &iter,
  ...
  template<class A, class B, class U, int Dim1, char i, int N, int Current_Dim>
  inline void T2rhs0_plus_equals_T1(A &iter,
  ...
  template<class A, class B, class U, int Dim1, char i, int N, int Current_Dim>
  inline void T2rhs0_minus_equals_T1(A &iter,
                                     const Tensor1_Expr<B,U,Dim1,i> &result,
                                     const Number<N> &N1,
                                     const Number<Current_Dim> &)
  {
  ...
  template<class A, class U, int N>
  inline void T2rhs0_plus_equals_generic(A &iter, const U &u, const Number<N> &,
                                         const Number<1> &)
  {
    iter(N,0)+=u;
  }
  ...
  template<class A, class U, int N>
  inline void T2rhs0_minus_equals_generic(A &iter, const U &u, const Number<N> &,
                                          const Number<1> &)
  {
    iter(N,0)-=u;
  }
  ...
  template<class A, class U, int N>
  inline void T2rhs0_times_equals_generic(A &iter, const U &u, const Number<N> &,
                                          const Number<1> &)
  {
    iter(N,0)*=u;
  }
  ...
  template<class A, class U, int N, int Current_Dim>
  inline void T2rhs0_divide_equals_generic(A &iter, const U &u,
                                           const Number<N> &N1,
                                           const Number<Current_Dim> &)
  {
    iter(N,Current_Dim-1)/=u;
  ...
  template<class A, class U, int N>
  inline void T2rhs0_divide_equals_generic(A &iter, const U &u, const Number<N> &,
                                           const Number<1> &)
  {
    iter(N,0)/=u;
  }
  ...
  template<class A, class B, class U, int Dim1, char i, int N, int Current_Dim>
  inline void T2rhs1_plus_equals_T1(A &iter, const Tensor1_Expr<B,U,Dim1,i> &result,
                                    const Number<N> &N1,
                                    const Number<Current_Dim> &)
  {
    iter(Current_Dim-1,N)+=result(Current_Dim-1);
  ...
  template<class A, class B, class U, int Dim1, char i, int N, int Current_Dim>
  inline void T2rhs1_minus_equals_T1(A &iter, const Tensor1_Expr<B,U,Dim1,i> &result,
                                     const Number<N> &N1,
                                     const Number<Current_Dim> &)
  {
    iter(Current_Dim-1,N)-=result(Current_Dim-1);
  ...
  template<class A, class U, int N>
  inline void T2rhs1_plus_equals_generic(A &iter, const U &u, const Number<N> &,
                                         const Number<1> &)
  {
    iter(0,N)+=u;
  }
  ...
  template<class A, class U, int N>
  inline void T2rhs1_minus_equals_generic(A &iter, const U &u, const Number<N> &,
                                          const Number<1> &)
  {
    iter(0,N)-=u;
  }
  ...
  template<class A, class U, int N>
  inline void T2rhs1_times_equals_generic(A &iter, const U &u, const Number<N> &,
                                          const Number<1> &)
  {
    iter(0,N)*=u;
  }
  ...
  template<class A, class U, int N, int Current_Dim>
  inline void T2rhs1_divide_equals_generic(A &iter, const U &u,
                                           const Number<N> &N1,
                                           const Number<Current_Dim> &)
  {
    iter(Current_Dim-1,N)/=u;
  ...
  template<class A, class U, int N>
  inline void T2rhs1_divide_equals_generic(A &iter, const U &u, const Number<N> &,
                                           const Number<1> &)
  {
    iter(0,N)/=u;
  }
  ...
  const Tensor1_Expr<Dg_number_rhs_12<A,T,N1,N2>,T,Dim,i> &
  Tensor1_Expr<Dg_number_rhs_12<A,T,N1,N2>,T,Dim,i>
  ::operator=(const Tensor1_Expr<Dg_number_rhs_12<A,T,N1,N2>,T,Dim,i>
              &result)
  {
  ...
  const Tensor1_Expr<Dg_number_rhs_01<A,T,N1,N2>,T,Dim,i> &
  Tensor1_Expr<Dg_number_rhs_01<A,T,N1,N2>,T,Dim,i>
  ::operator=(const Tensor1_Expr<Dg_number_rhs_01<A,T,N1,N2>,T,Dim,i>
              &result)
  {
