/* Subtracts a Dg from a Tensor3, yielding a Tensor3. */
...
namespace FTensor
{
  ...
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim0, Dim1, Dim2, i, j, k> &b)
  {
    typedef const Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, i, j, k>
      TensorExpr;
  ...
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim0, Dim2, Dim1, i, k, j> &b)
  {
    typedef const Tensor3_minus_Tensor3_21<A, B, T, U, Dim0, Dim1, Dim2, i, j,
                                           k>
      TensorExpr;
    return Tensor3_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1,
                        Dim2, i, j, k>(TensorExpr(a, b));
  ...
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim1, Dim0, Dim2, j, i, k> &b)
  {
    typedef const Tensor3_minus_Tensor3_10<A, B, T, U, Dim0, Dim1, Dim2, i, j,
                                           k>
      TensorExpr;
    return Tensor3_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1,
                        Dim2, i, j, k>(TensorExpr(a, b));
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  inline const Tensor3_Expr<
    const Tensor3_minus_Tensor3_201<A, B, T, U, Dim0, Dim1, Dim2, i, j, k>,
    typename promote<T, U>::V, Dim0, Dim1, Dim2, i, j, k>
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim2, Dim0, Dim1, j, k, i> &b)
  {
    typedef const Tensor3_minus_Tensor3_201<A, B, T, U, Dim0, Dim1, Dim2, i, j,
                                            k>
      TensorExpr;
    return Tensor3_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1,
                        Dim2, i, j, k>(TensorExpr(a, b));
  ...
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim2, Dim0, Dim1, k, i, j> &b)
  {
    typedef const Tensor3_minus_Tensor3_120<A, B, T, U, Dim0, Dim1, Dim2, i, j,
                                            k>
      TensorExpr;
    return Tensor3_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1,
                        Dim2, i, j, k>(TensorExpr(a, b));
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  inline const Tensor3_Expr<
    const Tensor3_minus_Tensor3_210<A, B, T, U, Dim0, Dim1, Dim2, i, j, k>,
    typename promote<T, U>::V, Dim0, Dim1, Dim2, i, j, k>
  operator-(const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a,
            const Tensor3_Expr<B, U, Dim2, Dim0, Dim1, k, j, i> &b)
  {
    typedef const Tensor3_minus_Tensor3_210<A, B, T, U, Dim0, Dim1, Dim2, i, j,
                                            k>
      TensorExpr;
    return Tensor3_Expr<TensorExpr, typename promote<T, U>::V, Dim0, Dim1,
                        Dim2, i, j, k>(TensorExpr(a, b));
