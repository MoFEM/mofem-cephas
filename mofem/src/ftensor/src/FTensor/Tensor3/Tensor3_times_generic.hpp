...
namespace FTensor
{
  ...
  public:
    ...
    Tensor3_times_generic(
      const Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> &a, const U &d0)
        : iterA(a), d(d0)
    {}
  };
  ...
  inline const Tensor3_Expr<
    const Tensor3_times_generic<A, T, U, Dim0, Dim1, Dim2, i, j, k>,
