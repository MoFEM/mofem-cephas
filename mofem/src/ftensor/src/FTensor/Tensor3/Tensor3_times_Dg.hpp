...
namespace FTensor
{
  ...
  (const Tensor3_Expr<A,T,Dim,Dim,Dim2,i,j,k> &a,
   const Dg_Expr<B,U,Dim,Dim2,i,j,k> &b,
   const Number<Current_Dim0> &, const Number<1> &, const Number<1> &)
  {
  ...
  public:
    ...
    (const Tensor3_Expr<A,T,Dim2,Dim1,Dim01,j,i,k> &a,
     const Dg_Expr<B,U,Dim01,Dim2,k,l,j> &b): iterA(a), iterB(b) {}
  ...
  {
    typedef const Tensor3_times_Dg_02_20<A,B,T,U,Dim2,Dim1,Dim01,i,j,k,l>
      TensorExpr;
  ...
  operator*(const Tensor3_Expr<A,T,Dim0,Dim1,Dim,i,j,k> &a,
            const Dg_Expr<B,U,Dim,Dim2,l,k,m> &b)
  {
    typedef const Tensor3_times_Dg
