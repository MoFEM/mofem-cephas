...
namespace FTensor
{
  ...
  inline void
  T3_increment(const Tensor3<T, Dim0, Dim1, Dim2> &iter,
  ...
  template <class T, int Dim0, int Dim1, int Dim2, int Current_Dim1,
            int Current_Dim2>
  inline void
  T3_increment(const Tensor3<T, Dim0, Dim1, Dim2> &iter, const Number<1> &,
               const Number<Current_Dim1> &, const Number<Current_Dim2> &)
  {
    iter.increment(Number<1>(), Number<Current_Dim1>(),
                   Number<Current_Dim2>());
  ...
  public:
    ...
    Tensor3(T *d000, T *d001, T *d002, T *d010, T *d011, T *d012, T *d020,
            ...
            T *d210, T *d211, T *d212, T *d220, T *d221, T *d222,
            const int i = 1)
        : inc(i)
    {
      Tensor3_constructor<T * restrict, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>(
  ...
  public:
    ...
    Tensor3(T *d000, T *d001, T *d002, T *d010, T *d011, T *d012, T *d020,
            ...
            T *d210, T *d211, T *d212, T *d220, T *d221, T *d222)
        : Tensor3<T *, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>(
              d000, d001, d002, d010, d011, d012, d020, d021, d022, d100,
              d101, d102, d110, d111, d112, d120, d121, d122, d200, d201, d202,
              d210, d211, d212, d220, d221, d222) {}

    /* Tensor_Dim0=4, Tensor_Dim1=4, Tensor_Dim2=4 */
    Tensor3(
        T *d000, T *d001, T *d002, T *d003, T *d010, T *d011, T *d012, T *d013,
        ...
        : Tensor3<T *, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>(
              ...
              d000, d001, d002, d003, d010, d011, d012, d013, d020, d021,
              d022, d023, d030, d031, d032, d033,

              d100, d101, d102, d103, d110, d111, d112, d113, d120, d121, d122,
              d123, d130, d131, d132, d133,

              d200, d201, d202, d203, d210, d211, d212, d213, d220, d221, d222,
              d223, d230, d231, d232, d233,

              d300, d301, d302, d303, d310, d311, d312, d313, d320, d321, d322,
              d323, d330, d331, d332, d333
