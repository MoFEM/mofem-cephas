...
namespace FTensor
{
  ...
  public:
    ...
    Tensor3_Expr<Tensor3<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>,
                 T, Dim0, Dim1, Dim2, i, j, k>
    operator()(const Index<i, Dim0>, const Index<j, Dim1>,
               const Index<k, Dim2>)
    {
      return Tensor3_Expr<
        Tensor3<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>, T,
        Dim0, Dim1, Dim2, i, j, k>(*this);
    }

    template <char i, char j, char k, int Dim0, int Dim1, int Dim2>
    Tensor3_Expr<
      const Tensor3<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1, Tensor_Dim2>, T,
    ...
    {
      data[Current_Dim0 - 1][Current_Dim1 - 1][Current_Dim2 - 1] += I;
    }
