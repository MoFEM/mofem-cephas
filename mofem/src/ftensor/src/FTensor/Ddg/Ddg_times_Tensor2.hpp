...
namespace FTensor
{
  ...
  <const Ddg_times_Tensor2_23<A,B,T,U,Dim01,Dim23,i,j,k,l>,
  ...
  {
    typedef const Ddg_times_Tensor2_23
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim23,
           char i, char j, char k, char l>
  inline const Tensor2_symmetric_Expr
  <const Ddg_times_Tensor2_32<A,B,T,U,Dim01,Dim23,i,j,k,l>,
   typename promote<T,U>::V,Dim01,i,j>
  operator*(const Ddg_Expr<A,T,Dim01,Dim23,i,j,k,l> &a,
            const Tensor2_Expr<B,U,Dim23,Dim23,l,k> &b)
  {
    typedef const Ddg_times_Tensor2_32
      <A,B,T,U,Dim01,Dim23,i,j,k,l> TensorExpr;
    return Tensor2_symmetric_Expr<TensorExpr,typename promote<T,U>::V,Dim01,i,j>
      (TensorExpr(a,b));
  }
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim4,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_3_1<
                                A, B, T, U, Dim01, Dim23, Dim4, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim01, Dim23,
                            Dim4, i, j, k, m>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim23, Dim4, l, m> &b) {
    typedef const Ddg_times_Tensor2_3_1<A, B, T, U, Dim01, Dim23, Dim4,
                                                i, j, k, l, m>
        TensorExpr;
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim4,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_3_0<
                                A, B, T, U, Dim01, Dim23, Dim4, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim01, Dim23,
                            Dim4, i, j, k, m>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim4, Dim23, m, l> &b) {
    typedef const Ddg_times_Tensor2_3_0<A, B, T, U, Dim01, Dim23, Dim4,
                                                i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim01, Dim01,
                        Dim23, Dim4, i, j, k, m>(TensorExpr(a, b));
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim4,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_2_0<
                                A, B, T, U, Dim01, Dim23, Dim4, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim01, Dim23,
                            Dim4, i, j, m, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim4, Dim23, m, k> &b) {
    typedef const Ddg_times_Tensor2_2_0<A, B, T, U, Dim01, Dim23, Dim4,
                                                i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim01, Dim01,
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim4,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_2_1<
                                A, B, T, U, Dim01, Dim23, Dim4, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim01, Dim23,
                            Dim4, i, j, m, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim4, Dim23, k, m> &b) {
    typedef const Ddg_times_Tensor2_2_1<A, B, T, U, Dim01, Dim23, Dim4,
                                                i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim01, Dim01,
                        Dim23, Dim4, i, j, m, l>(TensorExpr(a, b));
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim2,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_1_0<
                                A, B, T, U, Dim01, Dim23, Dim2, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim2, Dim23,
                            Dim23, i, m, k, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim01, Dim2, j, m> &b) {
    typedef const Ddg_times_Tensor2_1_0<A, B, T, U, Dim01, Dim23, Dim2,
                                                i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim01, Dim01,
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim2,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_1_1<
                                A, B, T, U, Dim01, Dim23, Dim2, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim01, Dim2, Dim23,
                            Dim23, i, m, k, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim01, Dim2, m, j> &b) {
    typedef const Ddg_times_Tensor2_1_1<A, B, T, U, Dim01, Dim23, Dim2,
                                                i, j, k, l, m>
        TensorExpr;
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim1,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_0_0<
                                A, B, T, U, Dim01, Dim23, Dim1, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim1, Dim01, Dim23,
                            Dim23, m, j, k, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim01, Dim1, i, m> &b) {
    typedef const Ddg_times_Tensor2_0_0<A, B, T, U, Dim01, Dim23, Dim1,
                                                i, j, k, l, m>
        TensorExpr;
  ...
  template <class A, class B, class T, class U, int Dim01, int Dim23, int Dim1,
            char i, char j, char k, char l, char m>
  inline const Tensor4_Expr<const Ddg_times_Tensor2_0_1<
                                A, B, T, U, Dim01, Dim23, Dim1, i, j, k, l, m>,
                            typename promote<T, U>::V, Dim1, Dim01, Dim23,
                            Dim23, m, j, k, l>
  operator*(const Ddg_Expr<A, T, Dim01, Dim23, i, j, k, l> &a,
            const Tensor2_Expr<B, U, Dim01, Dim1, m, i> &b) {
    typedef const Ddg_times_Tensor2_0_1<A, B, T, U, Dim01, Dim23, Dim1,
                                                i, j, k, l, m>
        TensorExpr;
    return Tensor4_Expr<TensorExpr, typename promote<T, U>::V, Dim01, Dim01,
