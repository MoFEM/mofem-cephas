...
namespace FTensor
{
  ...
  public:
    ...
    const Tensor2_symmetric_Expr<const Ddg_number_01
                                 <const Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T,N0,N1>,T,Dim,i,j>
    ...
    template<char i, char j, int N0, int N1, int Dim>
    Tensor2_symmetric_Expr<Ddg_number_rhs_01
                           <Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T,N0,N1>,T,Dim,i,j>
    operator()(const Number<N0> n1, const Number<N1> n2,
    ...
    const Dg_Expr<const Ddg_number_0
                          <const Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T,N0>,T,Dim23,Dim1,i,j,k>
    ...
    template<char i, char j, char k, int N0, int Dim1, int Dim23>
    Dg_Expr<Ddg_number_rhs_0
                    <Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T,N0>,T,Dim23,Dim1,i,j,k>
    operator()(const Number<N0> n1, const Index<k,Dim1> index3,
    ...
    const Tensor2_symmetric_Expr<const Ddg_numeral_01
                                 <const Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T>,T,Dim,i,j>
    ...
    template<char i, char j, int Dim>
    const Tensor2_symmetric_Expr<const Ddg_numeral_23
                                 <const Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T>,T,Dim,i,j>
    ...
    const Tensor1_Expr<const Ddg_numeral_123<const Ddg
    ...
    const Dg_Expr<const Ddg_numeral_0
                          <const Ddg<T*,Tensor_Dim01,Tensor_Dim23>,T>,T,Dim23,Dim1,i,j,k>
