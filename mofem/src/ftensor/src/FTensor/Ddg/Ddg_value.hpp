...
namespace FTensor
{
  ...
  public:
    ...
    typename std::enable_if<
      (Tensor_Dim01 >= Dim01 && Tensor_Dim23 >= Dim23),
    ...
    {
      typedef const Ddg_number_01<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T,
                                  N0, N1>
        TensorExpr;
    ...
    operator()(const int N0, const int N1, const Index<i, Dim>,
               const Index<j, Dim>) const
    {
      typedef const Ddg_numeral_01<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T>
        TensorExpr;
      return Tensor2_symmetric_Expr<TensorExpr, T, Dim, i, j>(
    ...
    operator()(const Index<i, Dim>, const Index<j, Dim>, const int N2,
               const int N3) const
    {
      typedef const Ddg_numeral_23<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T>
        TensorExpr;
      return Tensor2_symmetric_Expr<TensorExpr, T, Dim, i, j>(
    ...
    typename std::enable_if<
      ...
      const Tensor2_Expr<
        const Ddg_numeral_02<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T>, T,
        Dim1, Dim3, i, j>>::type
    operator()(const int N0, const Index<i, Dim1>, const int N2,
               const Index<j, Dim3>) const
    {
      typedef const Ddg_numeral_02<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T>
        TensorExpr;
    ...
    {
      typedef const Ddg_numeral_123<const Ddg<T, Tensor_Dim01, Tensor_Dim23>, T>
        TensorExpr;
