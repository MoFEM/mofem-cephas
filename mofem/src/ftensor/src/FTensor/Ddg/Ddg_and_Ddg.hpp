...
namespace FTensor
{
  ...
  {
    const Ddg_Expr<A,T,Dim,Dim,i,k,j,l> iterA;
  ...
  public:
    ...
    Ddg_and_Ddg0321
    (const Ddg_Expr<A,T,Dim,Dim,i,k,j,l> &a,
     const Ddg_Expr<B,U,Dim,Dim,i,l,k,j> &b): iterA(a), iterB(b) {}
  };

  template<class A, class B, class T, class U, int Dim,
           char i, char j, char k, char l>
  inline const Riemann_Expr
  <const Ddg_and_Ddg0321<A,B,T,U,Dim,i,j,k,l>,
   typename promote<T,U>::V,Dim,i,j,k,l>
  operator&&(const Ddg_Expr<A,T,Dim,Dim,i,k,j,l> &a,
             const Ddg_Expr<B,U,Dim,Dim,i,l,k,j> &b)
  {
    typedef const Ddg_and_Ddg0321<A,B,T,U,Dim,i,j,k,l> TensorExpr;
  ...
  {
    const Ddg_Expr<A,T,Dim,Dim,i,k,l,j> iterA;
    const Ddg_Expr<B,U,Dim,Dim,i,l,k,j> iterB;
  public:
    typename promote<T,U>::V operator()(const int N1, const int N2, const int N3,
                                        const int N4) const
    ...
    Ddg_and_Ddg0213
    (const Ddg_Expr<A,T,Dim,Dim,i,k,l,j> &a,
     const Ddg_Expr<B,U,Dim,Dim,i,l,k,j> &b): iterA(a), iterB(b) {}
  };
  ...
  template<class A, class B, class T, class U, int Dim,
           char i, char j, char k, char l>
  inline const Riemann_Expr
  <const Ddg_and_Ddg0213<A,B,T,U,Dim,i,j,k,l>,
   typename promote<T,U>::V,Dim,i,j,k,l>
  operator&&(const Ddg_Expr<A,T,Dim,Dim,i,k,l,j> &a,
             const Ddg_Expr<B,U,Dim,Dim,i,l,k,j> &b)
  {
    typedef const Ddg_and_Ddg0213<A,B,T,U,Dim,i,j,k,l>
      TensorExpr;
    return Riemann_Expr<TensorExpr,typename promote<T,U>::V,Dim,i,j,k,l>
      (TensorExpr(a,b));
  }
