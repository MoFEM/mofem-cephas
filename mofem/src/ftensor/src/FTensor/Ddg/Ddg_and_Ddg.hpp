...
namespace FTensor
{
  ...
  template <class A, class B, class T, class U, int Dim, char i, char j,
            char k, char l>
  inline const Riemann_Expr<const Ddg_and_Ddg0321<A, B, T, U, Dim, i, j, k, l>,
  ...
  template <class A, class B, class T, class U, int Dim, char i, char j,
            char k, char l>
  inline const Riemann_Expr<const Ddg_and_Ddg0213<A, B, T, U, Dim, i, j, k, l>,
                            typename promote<T, U>::V, Dim, i, j, k, l>
  operator&&(const Ddg_Expr<A, T, Dim, Dim, i, k, l, j> &a,
             const Ddg_Expr<B, U, Dim, Dim, i, l, k, j> &b)
  {
    typedef const Ddg_and_Ddg0213<A, B, T, U, Dim, i, j, k, l> TensorExpr;
    return Riemann_Expr<TensorExpr, typename promote<T, U>::V, Dim, i, j, k, l>(
      TensorExpr(a, b));
  }
}
