...
namespace FTensor
{
  ...
  public:
    ...
    Tensor2_Expr<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, Dim0, Dim1, i, j>
    operator()(const Index<i, Dim0>, const Index<j, Dim1> index2)
    {
      return Tensor2_Expr<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, Dim0,
                          Dim1, i, j>(*this);
    }

    template <char i, char j, int Dim0, int Dim1>
    Tensor2_Expr<const Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, Dim0, Dim1,
                 i, j>
    operator()(const Index<i, Dim0>, const Index<j, Dim1> index2) const
    {
      return Tensor2_Expr<const Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T,
                          Dim0, Dim1, i, j>(*this);
    }
    ...
    Tensor1_Expr<
      Tensor2_number_rhs_1<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>, T,
      Dim, i>
    operator()(const Index<i, Dim>, const Number<N>)
    {
      using TensorExpr
        = Tensor2_number_rhs_1<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>;
      return Tensor1_Expr<TensorExpr, T, Dim, i>(*this);
    }

    template <char i, int Dim, int N>
    Tensor1_Expr<
      Tensor2_number_rhs_0<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>, T,
      Dim, i>
    operator()(const Number<N>, const Index<i, Dim>)
    {
      using TensorExpr
        = Tensor2_number_rhs_0<Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>;
      return Tensor1_Expr<TensorExpr, T, Dim, i>(*this);
    }

    template <char i, int Dim, int N>
    Tensor1_Expr<const Tensor2_number_1<
                   const Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>,
                 T, Dim, i>
    operator()(const Index<i, Dim>, const Number<N>) const
    {
      using TensorExpr
        = Tensor2_number_1<const Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>;
    ...
    {
      using TensorExpr
        = Tensor2_number_0<const Tensor2<PackPtr<T *, I>, Tensor_Dim0, Tensor_Dim1>, T, N>;
      return Tensor1_Expr<TensorExpr, T, Dim, i>(TensorExpr(*this));
    }
