...
namespace FTensor
{
  ...
  class Tensor2_carat_Tensor2_10
  {
    ...
    typename promote<T,U>::V eval(const int N1, const int N2, const Number<1> &) const
    {
  ...
  //  inline const Ddg_Expr<const Tensor2_carat_Tensor2_0213<A,B,T,U,Dim01,Dim23,i,j,k,l>,typename promote<T,U>::V,Dim01,Dim23,i,k,j,l>
