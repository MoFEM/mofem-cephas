...
namespace FTensor
{
  ...
  inline const Tensor1_Expr<
    const Tensor2_times_Tensor1_1<A, B, T, U, Dim0, Dim1, i, j>,
    typename promote<T, U>::V, Dim0, i>
  operator*(const Tensor2_Expr<A, T, Dim0, Dim1, i, j> &a,
            const Tensor1_Expr<B, U, Dim1, j> &b)
  {
    typedef const Tensor2_times_Tensor1_1<A, B, T, U, Dim0, Dim1, i, j>
      TensorExpr;
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, char i,
            char j>
  inline const Tensor1_Expr<
    const Tensor2_times_Tensor1_0<A, B, T, U, Dim0, Dim1, i, j>,
    typename promote<T, U>::V, Dim0, i>
  operator*(const Tensor2_Expr<A, T, Dim1, Dim0, j, i> &a,
            const Tensor1_Expr<B, U, Dim1, j> &b)
  {
    typedef const Tensor2_times_Tensor1_0<A, B, T, U, Dim0, Dim1, i, j>
      TensorExpr;
    return Tensor1_Expr<TensorExpr, typename promote<T, U>::V, Dim0, i>(
      TensorExpr(a, b));
  }
  ...
  inline const Tensor3_Expr<
    const Tensor2_times_Tensor1<A, B, T, U, Dim0, Dim1, Dim2, i, j, k>,
    typename promote<T, U>::V, Dim0, Dim1, Dim2, i, j, k>
  operator*(const Tensor2_Expr<A, T, Dim0, Dim1, i, j> &a,
            const Tensor1_Expr<B, U, Dim2, k> &b)
  {
    typedef const Tensor2_times_Tensor1<A, B, T, U, Dim0, Dim1, Dim2, i, j, k>
      TensorExpr;
