...
namespace FTensor
{
  ...
  {
  public:
    Dg_constructor(T data[3][2], T d000, T d001, T d010, T d011,
                           T d110, T d111)
    {
      data[0][0]=d000;
      data[0][1]=d001;
  ...
  {
  public:
    Dg_constructor(T data[10][4], T d000, T d001, T d002, T d003,
  ...
  {
  public:
    Dg_constructor(T data[10][3], T d000, T d001, T d002,
