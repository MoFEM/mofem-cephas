...
namespace FTensor
{
  ...
  inline const Dg_Expr<Dg<A, Tensor_Dim01, Tensor_Dim2>, T, Dim01, Dim2, i, j,
                       k> &
  ...
  inline void
  T3dg_equals_generic(A &iter, const U &u, const Number<Current_Dim0> &,
  ...
  template <class A, class U, int Dim01, int Dim2, int Current_Dim1,
            int Current_Dim2>
  inline void T3dg_equals_generic(A &iter, const U &u, const Number<1> &,
                                  const Number<Current_Dim1> &,
                                  const Number<Current_Dim2> &,
  ...
  inline void
  T3dg_equals_generic(A &iter, const U &u, const Number<1> &,
  ...
  template <class B, class U>
  inline const Dg_Expr<Christof<Tp, Tensor_Dim0, Tensor_Dim12>, T, Dim12, Dim0,
                       i, j, k> &
  ...
  template <class A, class U, int Dim12, int Dim0, int Current_Dim0,
            int Current_Dim1, int Current_Dim2>
  inline void
  T3ch_equals_generic(A &iter, const U &u, const Number<Current_Dim0> &,
                      const Number<Current_Dim1> &,
  ...
  template <class A, class U, int Dim12, int Dim0, int Current_Dim1,
            int Current_Dim2>
  inline void T3ch_equals_generic(A &iter, const U &u, const Number<1> &,
                                  const Number<Current_Dim1> &,
                                  const Number<Current_Dim2> &,
  ...
  inline void
  T3ch_equals_generic(A &iter, const U &u, const Number<1> &,
                      const Number<1> &, const Number<Current_Dim2> &,
                      const Number<Dim12> &, const Number<Dim0> &)
  {
  ...
  template <class A, class T, int Tensor_Dim0, int Tensor_Dim12, int Dim12,
            int Dim0, char i, char j, char k>
  template <class U>
  inline const Dg_Expr<Christof<A, Tensor_Dim0, Tensor_Dim12>, T, Dim12, Dim0,
                       i, j, k> &
  ...
  template <class A, class T, int Dim23, int Dim1, char i, char j, char k,
            int N>
  template <class B, class U>
  inline const Dg_Expr<Ddg_number_rhs_0<A, T, N>, T, Dim23, Dim1, i, j, k> &
