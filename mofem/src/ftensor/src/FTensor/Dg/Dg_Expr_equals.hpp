...
namespace FTensor
{
  ...
  (A &iter, const Dg_Expr<B,U,Dim01,Dim2,i,j,k> &result,
  ...
  const Dg_Expr<Dg<A,Tensor_Dim01,Tensor_Dim2>,T,Dim01,Dim2,i,j,k> &
  ...
  const Dg_Expr<Dg<A,Tensor_Dim01,Tensor_Dim2>,T,Dim01,Dim2,i,j,k> &
  Dg_Expr<Dg<A,Tensor_Dim01,Tensor_Dim2>,T,Dim01,Dim2,i,j,k>::
  operator=(const Dg_Expr<Dg<A,Tensor_Dim01,Tensor_Dim2>,T,Dim01,Dim2,i,j,k> &result)
  {
  ...
  (A &iter, const Dg_Expr<B,U,Dim12,Dim0,i,j,k> &result,
   const Number<Current_Dim0> &, const Number<Current_Dim1> &,
   const Number<Current_Dim2> &)
  {
  ...
  template<class B, class U> inline
  const Dg_Expr<Christof<Tp,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k> &
  ...
  const Dg_Expr<Christof<Tp,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k> &
  Dg_Expr<Christof<Tp,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k>::
  operator=(const Dg_Expr<Christof<Tp,Tensor_Dim0,Tensor_Dim12>,
  ...
  template<class A, class T, int Tensor_Dim0, int Tensor_Dim12,
           int Dim12, int Dim0, char i, char j, char k>
  template<class U> inline
  const Dg_Expr<Christof<A,Tensor_Dim0,Tensor_Dim12>,
                        T,Dim12,Dim0,i,j,k> &
  Dg_Expr<Christof<A,Tensor_Dim0,Tensor_Dim12>,
                  T,Dim12,Dim0,i,j,k>::
  operator=(const U &u)
  {
  ...
  (A &iter, const Dg_Expr<B,U,Dim23,Dim1,i,j,k> &result,
   const Number<Current_Dim0> &, const Number<Current_Dim1> &,
  ...
  template<class B, class U> inline
  const Dg_Expr<Ddg_number_rhs_0<A,T,N>,T,Dim23,Dim1,i,j,k> &
  ...
  const Dg_Expr<Ddg_number_rhs_0<A,T,N>,T,Dim23,Dim1,i,j,k> &
  Dg_Expr<Ddg_number_rhs_0<A,T,N>,T,Dim23,Dim1,i,j,k>::
  operator=(const Dg_Expr<Ddg_number_rhs_0<A,T,N>,
