...
namespace FTensor
{
  ...
  public:
    ...
    inline Tensor1_Expr<const Tensor3_contracted_01<Dg
    ...
    template<char i, char j, int N, int Dim1, int Dim2>
    const Tensor2_Expr<const Dg_number_0<const Dg
    ...
    Tensor2_Expr<Dg_number_rhs_0<Dg
    ...
    Tensor2_symmetric_Expr<Dg_number_rhs_2<Dg
    ...
    template<char i, int N1, int N2, int Dim>
    const Tensor1_Expr<const Dg_number_12<const Dg
    ...
    template<char i, int N1, int N2, int Dim>
    Tensor1_Expr<Dg_number_rhs_01<Dg
                                          <T*,Tensor_Dim01,Tensor_Dim2>,T,N1,N2>,T,Dim,i>
    ...
    template<char i, int N1, int N2, int Dim>
    const Tensor1_Expr<const Dg_number_01<const Dg
                                                  <T*,Tensor_Dim01,Tensor_Dim2>,T,N1,N2>,T,Dim,i>
    operator()(const Number<N1> n1, const Number<N2> n2,
    ...
    const Tensor2_Expr<const Dg_numeral_0<const Dg
    ...
    const Tensor1_Expr<const Dg_numeral_12<const Dg
    ...
    template<char i, int Dim>
    const Tensor1_Expr<const Dg_numeral_01<const Dg
                                                   <T*,Tensor_Dim01,Tensor_Dim2>,T>,T,Dim,i>
