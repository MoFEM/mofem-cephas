...
namespace FTensor
{
  ...
  public:
    ...
    inline const Dg_Expr<Dg<A, Tensor_Dim01, Tensor_Dim2>, T, Dim01, Dim2, i,
                         j, k> &
  ...
  public:
    ...
    template <class B, class U>
    inline const Dg_Expr<Christof<A, Tensor_Dim0, Tensor_Dim12>, T, Dim12,
                         Dim0, i, j, k> &
  ...
  public:
    ...
    template <class B, class U>
    const Dg_Expr<Ddg_number_rhs_0<A, T, N0>, T, Dim23, Dim1, i, j, k> &
