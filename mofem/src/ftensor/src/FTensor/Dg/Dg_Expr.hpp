...
namespace FTensor
{
  ...
  class Dg_Expr<const Christof<A,Tensor_Dim0,Tensor_Dim12>,
                        T,Dim12,Dim0,i,j,k>
  {
    const Christof<A,Tensor_Dim0,Tensor_Dim12> &iter;
  public:
  ...
  public:
    ...
    template<class B, class U> inline
    const Dg_Expr<Christof<A,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k> &
    operator=(const Dg_Expr<B,U,Dim12,Dim0,i,j,k> &result);

    inline
    const Dg_Expr<Christof<A,Tensor_Dim0,Tensor_Dim12>,T,Dim12,Dim0,i,j,k> &
    operator=(const Dg_Expr<Christof<A,Tensor_Dim0,Tensor_Dim12>,
  ...
  class Dg_Expr<Ddg_number_rhs_0<A,T,N0>,
                        T,Dim23,Dim1,i,j,k>
  {
    A &iter;
  public:
    ...
    const Dg_Expr<Ddg_number_rhs_0<A,T,N0>,
                          T,Dim23,Dim1,i,j,k> &
    operator=(const Dg_Expr<B,U,Dim23,Dim1,i,j,k> &result);

    const Dg_Expr<Ddg_number_rhs_0<A,T,N0>,
                          T,Dim23,Dim1,i,j,k> &
    operator=(const Dg_Expr<Ddg_number_rhs_0<A,T,N0>,
