...
namespace FTensor
{
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2, 
           char i, char j, char k>
  inline const Tensor2_Expr<const Dg_times_Tensor1_1<A,B,T,U,Dim01,Dim2,i,j,k>,
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2, 
           char i, char j, char k>
  inline const Tensor2_Expr<const Dg_times_Tensor1_0<A,B,T,U,Dim01,Dim2,i,j,k>,
                            typename promote<T,U>::V,Dim01,Dim2,i,j>
