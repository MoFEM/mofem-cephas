...
namespace FTensor
{
  ...
  <const Dg_times_Tensor2_0<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>,
   typename promote<T,U>::V,Dim01,Dim3,i,j,l>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim2,Dim3,k,l> &b)
  {
    typedef const Dg_times_Tensor2_0<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>
      TensorExpr;
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2, int Dim3,
           char i, char j, char k, char l>
  inline const Dg_Expr
  <const Dg_times_Tensor2_1<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>,
   typename promote<T,U>::V,Dim01,Dim3,i,j,l>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim3,Dim2,l,k> &b)
  {
    typedef const Dg_times_Tensor2_1<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>
      TensorExpr;
    return Dg_Expr<TensorExpr,typename promote<T,U>::V,Dim01,Dim3,i,j,l>
      (TensorExpr(a,b));
  }
  ...
  <const Dg_times_Tensor2_1_0<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>,
   typename promote<T,U>::V,Dim01,Dim2,Dim3,i,k,l>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim01,Dim3,j,l> &b)
  {
    typedef const Dg_times_Tensor2_1_0<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>
      TensorExpr;
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2, int Dim3,
           char i, char j, char k, char l>
  inline const Tensor3_Expr
  <const Dg_times_Tensor2_1_1<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>,
   typename promote<T,U>::V,Dim01,Dim2,Dim3,i,k,l>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim3,Dim01,l,j> &b)
  {
    typedef const Dg_times_Tensor2_1_1<A,B,T,U,Dim01,Dim2,Dim3,i,j,k,l>
      TensorExpr;
    return Tensor3_Expr<TensorExpr,typename promote<T,U>::V,Dim01,Dim2,Dim3,i,k,l>
      (TensorExpr(a,b));
  }
  ...
  <const Dg_times_Tensor2_12<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim01,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim01,Dim2,j,k> &b)
  {
    typedef const Dg_times_Tensor2_12<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2,
           char i, char j, char k>
  inline const Tensor1_Expr
  <const Dg_times_Tensor2_21<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim01,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,i,j,k> &a,
            const Tensor2_Expr<B,U,Dim2,Dim01,k,j> &b)
  {
    typedef const Dg_times_Tensor2_21<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
    return Tensor1_Expr<TensorExpr,typename promote<T,U>::V,Dim01,i>(TensorExpr(a,b));
  }
  ...
  {
    const Dg_Expr<A,T,Dim01,Dim2,j,i,k> iterA;
    const Tensor2_Expr<B,U,Dim01,Dim2,j,k> iterB;
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2,
           char i, char j, char k>
  inline const Tensor1_Expr
  <const Dg_times_Tensor2_02<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim01,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,j,i,k> &a,
            const Tensor2_Expr<B,U,Dim01,Dim2,j,k> &b)
  {
    typedef const Dg_times_Tensor2_02<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
    return Tensor1_Expr<TensorExpr,typename promote<T,U>::V,Dim01,i>(TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2,
           char i, char j, char k>
  inline const Tensor1_Expr
  <const Dg_times_Tensor2_20<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim01,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,k,i,j> &a,
            const Tensor2_Expr<B,U,Dim2,Dim01,j,k> &b)
  {
    typedef const Dg_times_Tensor2_20<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
    return Tensor1_Expr<TensorExpr,typename promote<T,U>::V,Dim01,i>(TensorExpr(a,b));
  }
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2,
           char i, char j, char k>
  inline const Tensor1_Expr
  <const Dg_times_Tensor2_01<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim2,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,j,k,i> &a,
            const Tensor2_Expr<B,U,Dim01,Dim01,j,k> &b)
  {
    typedef const Dg_times_Tensor2_01<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
  ...
  template<class A, class B, class T, class U, int Dim01, int Dim2,
           char i, char j, char k>
  inline const Tensor1_Expr
  <const Dg_times_Tensor2_10<A,B,T,U,Dim01,Dim2,i,j,k>,
   typename promote<T,U>::V,Dim2,i>
  operator*(const Dg_Expr<A,T,Dim01,Dim2,j,k,i> &a,
            const Tensor2_Expr<B,U,Dim01,Dim01,k,j> &b)
  {
    typedef const Dg_times_Tensor2_10<A,B,T,U,Dim01,Dim2,i,j,k>
      TensorExpr;
    return Tensor1_Expr<TensorExpr,typename promote<T,U>::V,Dim2,i>(TensorExpr(a,b));
  }
