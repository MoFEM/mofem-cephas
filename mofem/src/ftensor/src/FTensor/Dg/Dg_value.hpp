...
namespace FTensor
{
  ...
  public:
    ...
    Dg(T d000, T d001, T d002, T d010,
    ...
    Dg(T d000, T d001, T d002, T d003,
    ...
    Dg(T d000, T d001, T d002, T d010, T d011, T d012,
    ...
    typename std::enable_if<(Tensor_Dim01 >= Dim && Tensor_Dim2 >= Dim),
        Tensor1_Expr<const Tensor3_contracted_12<Dg<T,Tensor_Dim01,Tensor_Dim2>,
                    T,Dim>,T,Dim,i> >::type
    ...
    inline
    typename std::enable_if<(Tensor_Dim01 >= Dim && Tensor_Dim2 >= Dim),
            Tensor1_Expr<const Tensor3_contracted_02<Dg<T,Tensor_Dim01,Tensor_Dim2>,
                 T,Dim>,T,Dim,i> >::type
    ...
    inline
    typename std::enable_if<(Tensor_Dim01 >= Dim01 && Tensor_Dim2 >= Dim2),
            Tensor1_Expr<const Tensor3_contracted_01<Dg<T,Tensor_Dim01,Tensor_Dim2>,
    ...
    template<char i, char j, int N, int Dim1, int Dim2>
    typename std::enable_if<(Tensor_Dim01 > N && Tensor_Dim01 >= Dim1 && Tensor_Dim2 >= Dim2),
        const Tensor2_Expr<const Dg_number_0<const Dg<T,Tensor_Dim01,Tensor_Dim2>,
                   T,N>,T,Dim1,Dim2,i,j> >::type
    operator()(const Number<N> , const Index<i,Dim1> ,
               const Index<j,Dim2> ) const
    {
      typedef const Dg_number_0<const Dg
    ...
    typename std::enable_if<(Tensor_Dim01 >= Dim && Tensor_Dim2 > N),
            Tensor2_symmetric_Expr<Dg_number_rhs_2<Dg<T,Tensor_Dim01,Tensor_Dim2>,
                 T,N>,T,Dim,i,j> >::type
    operator()(const Index<i,Dim> , const Index<j,Dim> ,
               const Number<N> )
    {
    ...
    template<char i, char j, int N, int Dim>
    typename std::enable_if<(Tensor_Dim01 >= Dim && Tensor_Dim2 > N),
        const Tensor2_symmetric_Expr<const Dg_number_2<const Dg<T,Tensor_Dim01,Tensor_Dim2>,
                   T,N>,T,Dim,i,j> >::type
    operator()(const Index<i,Dim> , const Index<j,Dim> ,
               const Number<N> ) const
    {
      typedef const Dg_number_2<const Dg
                                        <T,Tensor_Dim01,Tensor_Dim2>,T,N> TensorExpr;
    ...
    operator()(const Index<i,Dim> index, const Number<N1> ,
               const Number<N2> )
    {
      typedef Dg_number_rhs_12<Dg<T,Tensor_Dim01,Tensor_Dim2>,
                                       T,N1,N2> TensorExpr;
    ...
    {
      typedef const Dg_number_12<const Dg
    ...
    {
      typedef Dg_number_rhs_01<Dg<T,Tensor_Dim01,Tensor_Dim2>,
                                       T,N0,N1> TensorExpr;
      return Tensor1_Expr<TensorExpr,T,Dim,i>(*this);
    }
    ...
    {
      typedef const Dg_number_01<const Dg
    ...
    typename std::enable_if<(Tensor_Dim01 >= Dim1 && Tensor_Dim2 >= Dim2),
        const Tensor2_Expr<const Dg_numeral_0<const Dg<T,Tensor_Dim01,Tensor_Dim2>,
                   T>,T,Dim1,Dim2,i,j> >::type
    operator()(const int N, const Index<i,Dim1> ,
               const Index<j,Dim2> ) const
    {
      typedef const Dg_numeral_0<const Dg
    ...
    typename std::enable_if<(Tensor_Dim01 >= Dim),
        const Tensor2_symmetric_Expr<const Dg_numeral_2<const Dg<T,Tensor_Dim01,Tensor_Dim2>,
                   T>,T,Dim,i,j> >::type
    operator()(const Index<i,Dim> , const Index<j,Dim> ,
               const int N) const
    {
      typedef const Dg_numeral_2<const Dg
                                         <T,Tensor_Dim01,Tensor_Dim2>,T> TensorExpr;
    ...
    operator()(const Index<i,Dim> index, const int N1,
               const int N2) const
    {
      typedef const Dg_numeral_12<const Dg
                                          <T,Tensor_Dim01,Tensor_Dim2>,T> TensorExpr;
    ...
    operator()(const int N1, const int N2,
               const Index<i,Dim> ) const
    {
      typedef const Dg_numeral_01<const Dg
                                          <T,Tensor_Dim01,Tensor_Dim2>,T> TensorExpr;
      return Tensor1_Expr<TensorExpr,T,Dim,i>(TensorExpr(*this,N1,N2));
    }
  };
