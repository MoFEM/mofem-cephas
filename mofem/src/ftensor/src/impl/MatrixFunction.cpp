...
getMatSpecial(Val<FTensor::PackPtr<double *, 1>, 2> &t_val,
  ...
  return getMatImpl<FTensor::PackPtr<double *, 1>, 2>(t_val, t_vec, f);
}
...
getDiffMatSpecial(Val<FTensor::PackPtr<double *, 1>, 2> &t_val,
                  Vec<FTensor::PackPtr<double *, 1>, 2> &t_vec, Fun<double> f,
                  Fun<double> d_f, const int nb) {
  return getDiffMatImpl<FTensor::PackPtr<double *, 1>, 2>(t_val, t_vec, f, d_f,
                                                          nb);
}
...
getDiffDiffMatSpecial(Val<FTensor::PackPtr<double *, 1>, 2> &t_val,
                      ...
                      const int nb) {
  return getDiffDiffMatImpl<FTensor::PackPtr<double *, 1>,
                            FTensor::Tensor2_symmetric<double, 2>, 2>(
      t_val, t_vec, f, d_f, dd_f, t_S, nb);
}
...
FTensor::Ddg<double, 2, 2> getDiffDiffMatSpecial(
    ...
    const int nb) {
  return getDiffDiffMatImpl<
      FTensor::PackPtr<double *, 1>,
      FTensor::Tensor2_symmetric<FTensor::PackPtr<double *, 1>, 2>, 2>(
      t_val, t_vec, f, d_f, dd_f, t_S, nb);
}
...
FTensor::Ddg<double, 3, 3> getDiffDiffMatSpecial(
  ...
  return getDiffDiffMatImpl<
      FTensor::PackPtr<double *, 1>,
      FTensor::Tensor2_symmetric<FTensor::PackPtr<double *, 1>, 3>, 3>(
      t_val, t_vec, f, d_f, dd_f, t_S, nb);
}
