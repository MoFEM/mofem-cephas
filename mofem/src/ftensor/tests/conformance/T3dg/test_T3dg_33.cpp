  ...
  test_for_zero(
    t1_1(0)
      - (t3dg_2(0, 0, 0) * t2s_2(0, 0) + t3dg_2(0, 0, 1) * t2s_2(1, 0)
         + t3dg_2(0, 0, 2) * t2s_2(2, 0) + t3dg_2(1, 0, 0) * t2s_2(0, 1)
         + t3dg_2(1, 0, 1) * t2s_2(1, 1) + t3dg_2(1, 0, 2) * t2s_2(2, 1)
         + t3dg_2(2, 0, 0) * t2s_2(0, 2) + t3dg_2(2, 0, 1) * t2s_2(1, 2)
         + t3dg_2(2, 0, 2) * t2s_2(2, 2)),
    "T3dg(j,i,k)*T2s(k,j)(0)");
  test_for_zero(
    t1_1(1)
      - (t3dg_2(0, 1, 0) * t2s_2(0, 0) + t3dg_2(0, 1, 1) * t2s_2(1, 0)
         + t3dg_2(0, 1, 2) * t2s_2(2, 0) + t3dg_2(1, 1, 0) * t2s_2(0, 1)
         + t3dg_2(1, 1, 1) * t2s_2(1, 1) + t3dg_2(1, 1, 2) * t2s_2(2, 1)
         + t3dg_2(2, 1, 0) * t2s_2(0, 2) + t3dg_2(2, 1, 1) * t2s_2(1, 2)
         + t3dg_2(2, 1, 2) * t2s_2(2, 2)),
    "T3dg(j,i,k)*T2s(k,j)(1)");
  test_for_zero(
    t1_1(2)
      - (t3dg_2(0, 2, 0) * t2s_2(0, 0) + t3dg_2(0, 2, 1) * t2s_2(1, 0)
         + t3dg_2(0, 2, 2) * t2s_2(2, 0) + t3dg_2(1, 2, 0) * t2s_2(0, 1)
         + t3dg_2(1, 2, 1) * t2s_2(1, 1) + t3dg_2(1, 2, 2) * t2s_2(2, 1)
