                   ...
                   const Dg<double, 3, 3> &t3dg_3)
{
  ...
  test_for_zero((t4ddg_1(0, 2, 0, 0) - (t1_3(0) * t1_3(0)))
                  / t4ddg_1(0, 2, 0, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,0,0)");
  test_for_zero((t4ddg_1(0, 2, 0, 1) - (t1_3(0) * t1_3(1)))
                  / t4ddg_1(0, 2, 0, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,0,1)");
  test_for_zero((t4ddg_1(0, 2, 0, 2) - (t1_3(0) * t1_3(2)))
                  / t4ddg_1(0, 2, 0, 2),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,0,2)");
  test_for_zero((t4ddg_1(0, 2, 1, 0) - (t1_3(1) * t1_3(0)))
                  / t4ddg_1(0, 2, 1, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,1,0)");
  test_for_zero((t4ddg_1(0, 2, 1, 1) - (t1_3(1) * t1_3(1)))
                  / t4ddg_1(0, 2, 1, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,1,1)");
  test_for_zero((t4ddg_1(0, 2, 1, 2) - (t1_3(1) * t1_3(2)))
                  / t4ddg_1(0, 2, 1, 2),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,1,2)");
  test_for_zero((t4ddg_1(0, 2, 2, 0) - (t1_3(2) * t1_3(0)))
                  / t4ddg_1(0, 2, 2, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,2,0)");
  test_for_zero((t4ddg_1(0, 2, 2, 1) - (t1_3(2) * t1_3(1)))
                  / t4ddg_1(0, 2, 2, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(0,2,2,1)");
  test_for_zero((t4ddg_1(0, 2, 2, 2) - (t1_3(2) * t1_3(2)))
                  / t4ddg_1(0, 2, 2, 2),
  ...
  test_for_zero((t4ddg_1(2, 0, 0, 0) - (t1_3(0) * t1_3(0)))
                  / t4ddg_1(2, 0, 0, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,0,0)");
  test_for_zero((t4ddg_1(2, 0, 0, 1) - (t1_3(0) * t1_3(1)))
                  / t4ddg_1(2, 0, 0, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,0,1)");
  test_for_zero((t4ddg_1(2, 0, 0, 2) - (t1_3(0) * t1_3(2)))
                  / t4ddg_1(2, 0, 0, 2),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,0,2)");
  test_for_zero((t4ddg_1(2, 0, 1, 0) - (t1_3(1) * t1_3(0)))
                  / t4ddg_1(2, 0, 1, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,1,0)");
  test_for_zero((t4ddg_1(2, 0, 1, 1) - (t1_3(1) * t1_3(1)))
                  / t4ddg_1(2, 0, 1, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,1,1)");
  test_for_zero((t4ddg_1(2, 0, 1, 2) - (t1_3(1) * t1_3(2)))
                  / t4ddg_1(2, 0, 1, 2),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,1,2)");
  test_for_zero((t4ddg_1(2, 0, 2, 0) - (t1_3(2) * t1_3(0)))
                  / t4ddg_1(2, 0, 2, 0),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,2,0)");
  test_for_zero((t4ddg_1(2, 0, 2, 1) - (t1_3(2) * t1_3(1)))
                  / t4ddg_1(2, 0, 2, 1),
                "T4ddg(N,N,i,j)=T2s(i,j)(2,0,2,1)");
  test_for_zero((t4ddg_1(2, 0, 2, 2) - (t1_3(2) * t1_3(2)))
                  / t4ddg_1(2, 0, 2, 2),
  ...
  test_for_zero(t4ddg_2(0, 0, 2, 2) - 13 * (t1_1(2) * t1_1(2)),
                "T*T4ddg(0,0,2,2)");
  test_for_zero(t4ddg_2(0, 1, 0, 0) - 13 * (t2s_1(0, 0)), "T*T4ddg(0,1,0,0)");
  test_for_zero(t4ddg_2(0, 1, 0, 1) - 13 * (t2s_1(0, 1)), "T*T4ddg(0,1,0,1)");
  test_for_zero(t4ddg_2(0, 1, 0, 2) - 13 * (t2s_1(0, 2)), "T*T4ddg(0,1,0,2)");
  test_for_zero(t4ddg_2(0, 1, 1, 0) - 13 * (t2s_1(1, 0)), "T*T4ddg(0,1,1,0)");
  test_for_zero(t4ddg_2(0, 1, 1, 1) - 13 * (t2s_1(1, 1)), "T*T4ddg(0,1,1,1)");
  test_for_zero(t4ddg_2(0, 1, 1, 2) - 13 * (t2s_1(1, 2)), "T*T4ddg(0,1,1,2)");
  test_for_zero(t4ddg_2(0, 1, 2, 0) - 13 * (t2s_1(2, 0)), "T*T4ddg(0,1,2,0)");
  test_for_zero(t4ddg_2(0, 1, 2, 1) - 13 * (t2s_1(2, 1)), "T*T4ddg(0,1,2,1)");
  test_for_zero(t4ddg_2(0, 1, 2, 2) - 13 * (t2s_1(2, 2)), "T*T4ddg(0,1,2,2)");
  test_for_zero((t4ddg_2(0, 2, 0, 0) - 13 * (t1_3(0) * t1_3(0)))
                  / t4ddg_2(0, 2, 0, 0),
                "T*T4ddg(0,2,0,0)");
  test_for_zero((t4ddg_2(0, 2, 0, 1) - 13 * (t1_3(0) * t1_3(1)))
                  / t4ddg_2(0, 2, 0, 1),
                "T*T4ddg(0,2,0,1)");
  test_for_zero((t4ddg_2(0, 2, 0, 2) - 13 * (t1_3(0) * t1_3(2)))
                  / t4ddg_2(0, 2, 0, 2),
                "T*T4ddg(0,2,0,2)");
  test_for_zero((t4ddg_2(0, 2, 1, 0) - 13 * (t1_3(1) * t1_3(0)))
                  / t4ddg_2(0, 2, 1, 0),
                "T*T4ddg(0,2,1,0)");
  test_for_zero((t4ddg_2(0, 2, 1, 1) - 13 * (t1_3(1) * t1_3(1)))
                  / t4ddg_2(0, 2, 1, 1),
                "T*T4ddg(0,2,1,1)");
  test_for_zero((t4ddg_2(0, 2, 1, 2) - 13 * (t1_3(1) * t1_3(2)))
                  / t4ddg_2(0, 2, 1, 2),
                "T*T4ddg(0,2,1,2)");
  test_for_zero((t4ddg_2(0, 2, 2, 0) - 13 * (t1_3(2) * t1_3(0)))
                  / t4ddg_2(0, 2, 2, 0),
                "T*T4ddg(0,2,2,0)");
  test_for_zero((t4ddg_2(0, 2, 2, 1) - 13 * (t1_3(2) * t1_3(1)))
                  / t4ddg_2(0, 2, 2, 1),
                "T*T4ddg(0,2,2,1)");
  test_for_zero((t4ddg_2(0, 2, 2, 2) - 13 * (t1_3(2) * t1_3(2)))
                  / t4ddg_2(0, 2, 2, 2),
                "T*T4ddg(0,2,2,2)");
  test_for_zero(t4ddg_2(1, 0, 0, 0) - 13 * (t2s_1(0, 0)), "T*T4ddg(1,0,0,0)");
  test_for_zero(t4ddg_2(1, 0, 0, 1) - 13 * (t2s_1(0, 1)), "T*T4ddg(1,0,0,1)");
  test_for_zero(t4ddg_2(1, 0, 0, 2) - 13 * (t2s_1(0, 2)), "T*T4ddg(1,0,0,2)");
  test_for_zero(t4ddg_2(1, 0, 1, 0) - 13 * (t2s_1(1, 0)), "T*T4ddg(1,0,1,0)");
  test_for_zero(t4ddg_2(1, 0, 1, 1) - 13 * (t2s_1(1, 1)), "T*T4ddg(1,0,1,1)");
  test_for_zero(t4ddg_2(1, 0, 1, 2) - 13 * (t2s_1(1, 2)), "T*T4ddg(1,0,1,2)");
  test_for_zero(t4ddg_2(1, 0, 2, 0) - 13 * (t2s_1(2, 0)), "T*T4ddg(1,0,2,0)");
  test_for_zero(t4ddg_2(1, 0, 2, 1) - 13 * (t2s_1(2, 1)), "T*T4ddg(1,0,2,1)");
  test_for_zero(t4ddg_2(1, 0, 2, 2) - 13 * (t2s_1(2, 2)), "T*T4ddg(1,0,2,2)");
  test_for_zero(t4ddg_2(1, 1, 0, 0) - 13 * (t2s_2(0, 0)), "T*T4ddg(1,1,0,0)");
  test_for_zero(t4ddg_2(1, 1, 0, 1) - 13 * (t2s_2(0, 1)), "T*T4ddg(1,1,0,1)");
  test_for_zero(t4ddg_2(1, 1, 0, 2) - 13 * (t2s_2(0, 2)), "T*T4ddg(1,1,0,2)");
  test_for_zero(t4ddg_2(1, 1, 1, 0) - 13 * (t2s_2(1, 0)), "T*T4ddg(1,1,1,0)");
  test_for_zero(t4ddg_2(1, 1, 1, 1) - 13 * (t2s_2(1, 1)), "T*T4ddg(1,1,1,1)");
  test_for_zero(t4ddg_2(1, 1, 1, 2) - 13 * (t2s_2(1, 2)), "T*T4ddg(1,1,1,2)");
  test_for_zero(t4ddg_2(1, 1, 2, 0) - 13 * (t2s_2(2, 0)), "T*T4ddg(1,1,2,0)");
  test_for_zero(t4ddg_2(1, 1, 2, 1) - 13 * (t2s_2(2, 1)), "T*T4ddg(1,1,2,1)");
  test_for_zero(t4ddg_2(1, 1, 2, 2) - 13 * (t2s_2(2, 2)), "T*T4ddg(1,1,2,2)");
  ...
  test_for_zero(t4ddg_2(1, 2, 2, 2) - 13 * (t1_2(2) * t1_2(2)),
                "T*T4ddg(1,2,2,2)");
  test_for_zero((t4ddg_2(2, 0, 0, 0) - 13 * (t1_3(0) * t1_3(0)))
                  / t4ddg_2(2, 0, 0, 0),
                "T*T4ddg(2,0,0,0)");
  test_for_zero((t4ddg_2(2, 0, 0, 1) - 13 * (t1_3(0) * t1_3(1)))
                  / t4ddg_2(2, 0, 0, 1),
                "T*T4ddg(2,0,0,1)");
  test_for_zero((t4ddg_2(2, 0, 0, 2) - 13 * (t1_3(0) * t1_3(2)))
                  / t4ddg_2(2, 0, 0, 2),
                "T*T4ddg(2,0,0,2)");
  test_for_zero((t4ddg_2(2, 0, 1, 0) - 13 * (t1_3(1) * t1_3(0)))
                  / t4ddg_2(2, 0, 1, 0),
                "T*T4ddg(2,0,1,0)");
  test_for_zero((t4ddg_2(2, 0, 1, 1) - 13 * (t1_3(1) * t1_3(1)))
                  / t4ddg_2(2, 0, 1, 1),
                "T*T4ddg(2,0,1,1)");
  test_for_zero((t4ddg_2(2, 0, 1, 2) - 13 * (t1_3(1) * t1_3(2)))
                  / t4ddg_2(2, 0, 1, 2),
                "T*T4ddg(2,0,1,2)");
  test_for_zero((t4ddg_2(2, 0, 2, 0) - 13 * (t1_3(2) * t1_3(0)))
                  / t4ddg_2(2, 0, 2, 0),
                "T*T4ddg(2,0,2,0)");
  test_for_zero((t4ddg_2(2, 0, 2, 1) - 13 * (t1_3(2) * t1_3(1)))
                  / t4ddg_2(2, 0, 2, 1),
                "T*T4ddg(2,0,2,1)");
  test_for_zero((t4ddg_2(2, 0, 2, 2) - 13 * (t1_3(2) * t1_3(2)))
                  / t4ddg_2(2, 0, 2, 2),
                "T*T4ddg(2,0,2,2)");
  ...
  test_for_zero(t4ddg_2(2, 1, 2, 2) - 13 * (t1_2(2) * t1_2(2)),
                "T*T4ddg(2,1,2,2)");
  test_for_zero(t4ddg_2(2, 2, 0, 0) - 13 * (t2s_3(0, 0)), "T*T4ddg(2,2,0,0)");
  test_for_zero(t4ddg_2(2, 2, 0, 1) - 13 * (t2s_3(0, 1)), "T*T4ddg(2,2,0,1)");
  test_for_zero(t4ddg_2(2, 2, 0, 2) - 13 * (t2s_3(0, 2)), "T*T4ddg(2,2,0,2)");
  test_for_zero(t4ddg_2(2, 2, 1, 0) - 13 * (t2s_3(1, 0)), "T*T4ddg(2,2,1,0)");
  test_for_zero(t4ddg_2(2, 2, 1, 1) - 13 * (t2s_3(1, 1)), "T*T4ddg(2,2,1,1)");
  test_for_zero(t4ddg_2(2, 2, 1, 2) - 13 * (t2s_3(1, 2)), "T*T4ddg(2,2,1,2)");
  test_for_zero(t4ddg_2(2, 2, 2, 0) - 13 * (t2s_3(2, 0)), "T*T4ddg(2,2,2,0)");
  test_for_zero(t4ddg_2(2, 2, 2, 1) - 13 * (t2s_3(2, 1)), "T*T4ddg(2,2,2,1)");
  test_for_zero(t4ddg_2(2, 2, 2, 2) - 13 * (t2s_3(2, 2)), "T*T4ddg(2,2,2,2)");
  ...
  test_for_zero(t4ddg_2(0, 0, 2, 2) - 7 * (t1_1(2) * t1_1(2)),
                "T4ddg*T(0,0,2,2)");
  test_for_zero(t4ddg_2(0, 1, 0, 0) - 7 * (t2s_1(0, 0)), "T4ddg*T(0,1,0,0)");
  test_for_zero(t4ddg_2(0, 1, 0, 1) - 7 * (t2s_1(0, 1)), "T4ddg*T(0,1,0,1)");
  test_for_zero(t4ddg_2(0, 1, 0, 2) - 7 * (t2s_1(0, 2)), "T4ddg*T(0,1,0,2)");
  test_for_zero(t4ddg_2(0, 1, 1, 0) - 7 * (t2s_1(1, 0)), "T4ddg*T(0,1,1,0)");
  test_for_zero(t4ddg_2(0, 1, 1, 1) - 7 * (t2s_1(1, 1)), "T4ddg*T(0,1,1,1)");
  test_for_zero(t4ddg_2(0, 1, 1, 2) - 7 * (t2s_1(1, 2)), "T4ddg*T(0,1,1,2)");
  test_for_zero(t4ddg_2(0, 1, 2, 0) - 7 * (t2s_1(2, 0)), "T4ddg*T(0,1,2,0)");
  test_for_zero(t4ddg_2(0, 1, 2, 1) - 7 * (t2s_1(2, 1)), "T4ddg*T(0,1,2,1)");
  test_for_zero(t4ddg_2(0, 1, 2, 2) - 7 * (t2s_1(2, 2)), "T4ddg*T(0,1,2,2)");
  test_for_zero((t4ddg_2(0, 2, 0, 0) - 7 * (t1_3(0) * t1_3(0)))
                  / t4ddg_2(0, 2, 0, 0),
                "T4ddg*T(0,2,0,0)");
  test_for_zero((t4ddg_2(0, 2, 0, 1) - 7 * (t1_3(0) * t1_3(1)))
                  / t4ddg_2(0, 2, 0, 1),
                "T4ddg*T(0,2,0,1)");
  test_for_zero((t4ddg_2(0, 2, 0, 2) - 7 * (t1_3(0) * t1_3(2)))
                  / t4ddg_2(0, 2, 0, 2),
                "T4ddg*T(0,2,0,2)");
  test_for_zero((t4ddg_2(0, 2, 1, 0) - 7 * (t1_3(1) * t1_3(0)))
                  / t4ddg_2(0, 2, 1, 0),
                "T4ddg*T(0,2,1,0)");
  test_for_zero((t4ddg_2(0, 2, 1, 1) - 7 * (t1_3(1) * t1_3(1)))
                  / t4ddg_2(0, 2, 1, 1),
                "T4ddg*T(0,2,1,1)");
  test_for_zero((t4ddg_2(0, 2, 1, 2) - 7 * (t1_3(1) * t1_3(2)))
                  / t4ddg_2(0, 2, 1, 2),
                "T4ddg*T(0,2,1,2)");
  test_for_zero((t4ddg_2(0, 2, 2, 0) - 7 * (t1_3(2) * t1_3(0)))
                  / t4ddg_2(0, 2, 2, 0),
                "T4ddg*T(0,2,2,0)");
  test_for_zero((t4ddg_2(0, 2, 2, 1) - 7 * (t1_3(2) * t1_3(1)))
                  / t4ddg_2(0, 2, 2, 1),
                "T4ddg*T(0,2,2,1)");
  test_for_zero((t4ddg_2(0, 2, 2, 2) - 7 * (t1_3(2) * t1_3(2)))
                  / t4ddg_2(0, 2, 2, 2),
                "T4ddg*T(0,2,2,2)");
  test_for_zero(t4ddg_2(1, 0, 0, 0) - 7 * (t2s_1(0, 0)), "T4ddg*T(1,0,0,0)");
  test_for_zero(t4ddg_2(1, 0, 0, 1) - 7 * (t2s_1(0, 1)), "T4ddg*T(1,0,0,1)");
  test_for_zero(t4ddg_2(1, 0, 0, 2) - 7 * (t2s_1(0, 2)), "T4ddg*T(1,0,0,2)");
  test_for_zero(t4ddg_2(1, 0, 1, 0) - 7 * (t2s_1(1, 0)), "T4ddg*T(1,0,1,0)");
  test_for_zero(t4ddg_2(1, 0, 1, 1) - 7 * (t2s_1(1, 1)), "T4ddg*T(1,0,1,1)");
  test_for_zero(t4ddg_2(1, 0, 1, 2) - 7 * (t2s_1(1, 2)), "T4ddg*T(1,0,1,2)");
  test_for_zero(t4ddg_2(1, 0, 2, 0) - 7 * (t2s_1(2, 0)), "T4ddg*T(1,0,2,0)");
  test_for_zero(t4ddg_2(1, 0, 2, 1) - 7 * (t2s_1(2, 1)), "T4ddg*T(1,0,2,1)");
  test_for_zero(t4ddg_2(1, 0, 2, 2) - 7 * (t2s_1(2, 2)), "T4ddg*T(1,0,2,2)");
  test_for_zero(t4ddg_2(1, 1, 0, 0) - 7 * (t2s_2(0, 0)), "T4ddg*T(1,1,0,0)");
  test_for_zero(t4ddg_2(1, 1, 0, 1) - 7 * (t2s_2(0, 1)), "T4ddg*T(1,1,0,1)");
  test_for_zero(t4ddg_2(1, 1, 0, 2) - 7 * (t2s_2(0, 2)), "T4ddg*T(1,1,0,2)");
  test_for_zero(t4ddg_2(1, 1, 1, 0) - 7 * (t2s_2(1, 0)), "T4ddg*T(1,1,1,0)");
  test_for_zero(t4ddg_2(1, 1, 1, 1) - 7 * (t2s_2(1, 1)), "T4ddg*T(1,1,1,1)");
  test_for_zero(t4ddg_2(1, 1, 1, 2) - 7 * (t2s_2(1, 2)), "T4ddg*T(1,1,1,2)");
  test_for_zero(t4ddg_2(1, 1, 2, 0) - 7 * (t2s_2(2, 0)), "T4ddg*T(1,1,2,0)");
  test_for_zero(t4ddg_2(1, 1, 2, 1) - 7 * (t2s_2(2, 1)), "T4ddg*T(1,1,2,1)");
  test_for_zero(t4ddg_2(1, 1, 2, 2) - 7 * (t2s_2(2, 2)), "T4ddg*T(1,1,2,2)");
  ...
  test_for_zero(t4ddg_2(1, 2, 2, 2) - 7 * (t1_2(2) * t1_2(2)),
                "T4ddg*T(1,2,2,2)");
  test_for_zero((t4ddg_2(2, 0, 0, 0) - 7 * (t1_3(0) * t1_3(0)))
                  / t4ddg_2(2, 0, 0, 0),
                "T4ddg*T(2,0,0,0)");
  test_for_zero((t4ddg_2(2, 0, 0, 1) - 7 * (t1_3(0) * t1_3(1)))
                  / t4ddg_2(2, 0, 0, 1),
                "T4ddg*T(2,0,0,1)");
  test_for_zero((t4ddg_2(2, 0, 0, 2) - 7 * (t1_3(0) * t1_3(2)))
                  / t4ddg_2(2, 0, 0, 2),
                "T4ddg*T(2,0,0,2)");
  test_for_zero((t4ddg_2(2, 0, 1, 0) - 7 * (t1_3(1) * t1_3(0)))
                  / t4ddg_2(2, 0, 1, 0),
                "T4ddg*T(2,0,1,0)");
  test_for_zero((t4ddg_2(2, 0, 1, 1) - 7 * (t1_3(1) * t1_3(1)))
                  / t4ddg_2(2, 0, 1, 1),
                "T4ddg*T(2,0,1,1)");
  test_for_zero((t4ddg_2(2, 0, 1, 2) - 7 * (t1_3(1) * t1_3(2)))
                  / t4ddg_2(2, 0, 1, 2),
                "T4ddg*T(2,0,1,2)");
  test_for_zero((t4ddg_2(2, 0, 2, 0) - 7 * (t1_3(2) * t1_3(0)))
                  / t4ddg_2(2, 0, 2, 0),
                "T4ddg*T(2,0,2,0)");
  test_for_zero((t4ddg_2(2, 0, 2, 1) - 7 * (t1_3(2) * t1_3(1)))
                  / t4ddg_2(2, 0, 2, 1),
                "T4ddg*T(2,0,2,1)");
  test_for_zero((t4ddg_2(2, 0, 2, 2) - 7 * (t1_3(2) * t1_3(2)))
                  / t4ddg_2(2, 0, 2, 2),
                "T4ddg*T(2,0,2,2)");
  ...
  test_for_zero(t4ddg_2(2, 1, 2, 2) - 7 * (t1_2(2) * t1_2(2)),
                "T4ddg*T(2,1,2,2)");
  test_for_zero(t4ddg_2(2, 2, 0, 0) - 7 * (t2s_3(0, 0)), "T4ddg*T(2,2,0,0)");
  test_for_zero(t4ddg_2(2, 2, 0, 1) - 7 * (t2s_3(0, 1)), "T4ddg*T(2,2,0,1)");
  test_for_zero(t4ddg_2(2, 2, 0, 2) - 7 * (t2s_3(0, 2)), "T4ddg*T(2,2,0,2)");
  test_for_zero(t4ddg_2(2, 2, 1, 0) - 7 * (t2s_3(1, 0)), "T4ddg*T(2,2,1,0)");
  test_for_zero(t4ddg_2(2, 2, 1, 1) - 7 * (t2s_3(1, 1)), "T4ddg*T(2,2,1,1)");
  test_for_zero(t4ddg_2(2, 2, 1, 2) - 7 * (t2s_3(1, 2)), "T4ddg*T(2,2,1,2)");
  test_for_zero(t4ddg_2(2, 2, 2, 0) - 7 * (t2s_3(2, 0)), "T4ddg*T(2,2,2,0)");
  test_for_zero(t4ddg_2(2, 2, 2, 1) - 7 * (t2s_3(2, 1)), "T4ddg*T(2,2,2,1)");
  test_for_zero(t4ddg_2(2, 2, 2, 2) - 7 * (t2s_3(2, 2)), "T4ddg*T(2,2,2,2)");
