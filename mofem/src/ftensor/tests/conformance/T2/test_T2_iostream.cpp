...
{
  test_ostream(Tensor2<double,3,3,column_major>(3,7,11,13,17,23,27,31,37),
                   "[[3,7,11],[13,17,23],[27,31,37]]","operator<<(T2<3,3,c>)");
  test_ostream(Tensor2<double,3,3,row_major>(3,7,11,13,17,23,27,31,37),
                   "[[3,7,11],[13,17,23],[27,31,37]]","operator<<(T2<3,3,r>)");
  test_ostream(Tensor2<double,1,2,column_major>(13,17),
                   "[[13,17]]","operator<<(T2<1,2,c>)");
  test_ostream(Tensor2<double,1,2,row_major>(13,17),
                   "[[13,17]]","operator<<(T2<1,2,r>)");
  test_ostream(Tensor2<double,2,1,column_major>(13,17),
                   "[[13],[17]]","operator<<(T2<2,1,c>)");
  test_ostream(Tensor2<double,2,1,row_major>(13,17),
                   "[[13],[17]]","operator<<(T2<2,1,r>)");
