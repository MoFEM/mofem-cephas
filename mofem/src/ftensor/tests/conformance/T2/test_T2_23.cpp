...
void test_T2_23(const Tensor1<double,3> &t1_2, const Tensor2<double,3,3> &t2_2)
{
  ...
  test_for_zero(t1(0)-(t2_2(0,0)*t1_2(0) + t2_2(0,1)*t1_2(1)
			 + t2_2(0,2)*t1_2(2)),"T2(i,j)*T1(j)(0)");
  test_for_zero(t1(1)-(t2_2(1,0)*t1_2(0) + t2_2(1,1)*t1_2(1)
			 + t2_2(1,2)*t1_2(2)),"T2(i,j)*T1(j)(1)");
  test_for_zero(t1(2)-(t2_2(2,0)*t1_2(0) + t2_2(2,1)*t1_2(1)
  ...
  test_for_zero(t1(0)-(t2_2(0,0)*t1_2(0) + t2_2(1,0)*t1_2(1)
			 + t2_2(2,0)*t1_2(2)),"T2(i,j)*T1(i)(0)");
  test_for_zero(t1(1)-(t2_2(0,1)*t1_2(0) + t2_2(1,1)*t1_2(1)
			 + t2_2(2,1)*t1_2(2)),"T2(i,j)*T1(i)(1)");
  test_for_zero(t1(2)-(t2_2(0,2)*t1_2(0) + t2_2(1,2)*t1_2(1)
