                ...
                const Tensor2<double, 3, 3> &t2_2)
{
  ...
  test_for_zero(t2(0, 0) - (t2_2(0, 0) + t1_1(0) * t1_2(0)),
                "T2(i,j)+T2(j,i)(0,0)");
  test_for_zero(t2(1, 0) - (t2_2(1, 0) + t1_1(0) * t1_2(1)),
                "T2(i,j)+T2(j,i)(0,1)");
  test_for_zero(t2(2, 0) - (t2_2(2, 0) + t1_1(0) * t1_2(2)),
                "T2(i,j)+T2(j,i)(0,2)");
  test_for_zero(t2(0, 1) - (t2_2(0, 1) + t1_1(1) * t1_2(0)),
                "T2(i,j)+T2(j,i)(1,0)");
  test_for_zero(t2(1, 1) - (t2_2(1, 1) + t1_1(1) * t1_2(1)),
                "T2(i,j)+T2(j,i)(1,1)");
  test_for_zero(t2(2, 1) - (t2_2(2, 1) + t1_1(1) * t1_2(2)),
                "T2(i,j)+T2(j,i)(1,2)");
  test_for_zero(t2(0, 2) - (t2_2(0, 2) + t1_1(2) * t1_2(0)),
                "T2(i,j)+T2(j,i)(2,0)");
  test_for_zero(t2(1, 2) - (t2_2(1, 2) + t1_1(2) * t1_2(1)),
                "T2(i,j)+T2(j,i)(2,1)");
  test_for_zero(t2(2, 2) - (t2_2(2, 2) + t1_1(2) * t1_2(2)),
                "T2(i,j)+T2(j,i)(2,2)");
}
