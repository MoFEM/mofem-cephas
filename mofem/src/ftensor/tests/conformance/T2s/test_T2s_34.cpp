                 ...
                 const Tensor2_symmetric<double, 3> &t2s_2)
{
  ...
  test_for_zero(t2s_1(0, 0) - (t2s_2(0, 0) * t1_2(0) * t1_2(0)),
                "T2s(i,j)&T2s(i,j)(0,0)");
  test_for_zero(t2s_1(0, 1) - (t2s_2(0, 1) * t1_2(0) * t1_2(1)),
                "T2s(i,j)&T2s(i,j)(0,1)");
  test_for_zero(t2s_1(0, 2) - (t2s_2(0, 2) * t1_2(0) * t1_2(2)),
                "T2s(i,j)&T2s(i,j)(0,2)");
  test_for_zero(t2s_1(1, 0) - (t2s_2(1, 0) * t1_2(1) * t1_2(0)),
                "T2s(i,j)&T2s(i,j)(1,0)");
  test_for_zero(t2s_1(1, 1) - (t2s_2(1, 1) * t1_2(1) * t1_2(1)),
                "T2s(i,j)&T2s(i,j)(1,1)");
  test_for_zero(t2s_1(1, 2) - (t2s_2(1, 2) * t1_2(1) * t1_2(2)),
                "T2s(i,j)&T2s(i,j)(1,2)");
  test_for_zero(t2s_1(2, 0) - (t2s_2(2, 0) * t1_2(2) * t1_2(0)),
                "T2s(i,j)&T2s(i,j)(2,0)");
  test_for_zero(t2s_1(2, 1) - (t2s_2(2, 1) * t1_2(2) * t1_2(1)),
                "T2s(i,j)&T2s(i,j)(2,1)");
