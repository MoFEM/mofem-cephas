                 ...
                 const Tensor2_symmetric<double, 3> &t2s_2)
{
  ...
  test_for_zero(t2_1(0, 0)
                  - (t2s_2(0, 0) * t2_2(0, 0) + t2s_2(0, 1) * t2_2(0, 1)
                     + t2s_2(0, 2) * t2_2(0, 2)),
                "T2s(i,k)*T2(j,k)(0,0)");
  test_for_zero(t2_1(0, 1)
                  - (t2s_2(0, 0) * t2_2(1, 0) + t2s_2(0, 1) * t2_2(1, 1)
                     + t2s_2(0, 2) * t2_2(1, 2)),
                "T2s(i,k)*T2(j,k)(0,1)");
  test_for_zero(t2_1(0, 2)
                  - (t2s_2(0, 0) * t2_2(2, 0) + t2s_2(0, 1) * t2_2(2, 1)
                     + t2s_2(0, 2) * t2_2(2, 2)),
                "T2s(i,k)*T2(j,k)(0,2)");
  test_for_zero(t2_1(1, 0)
                  - (t2s_2(1, 0) * t2_2(0, 0) + t2s_2(1, 1) * t2_2(0, 1)
                     + t2s_2(1, 2) * t2_2(0, 2)),
                "T2s(i,k)*T2(j,k)(1,0)");
  test_for_zero(t2_1(1, 1)
                  - (t2s_2(1, 0) * t2_2(1, 0) + t2s_2(1, 1) * t2_2(1, 1)
                     + t2s_2(1, 2) * t2_2(1, 2)),
                "T2s(i,k)*T2(j,k)(1,1)");
  test_for_zero(t2_1(1, 2)
                  - (t2s_2(1, 0) * t2_2(2, 0) + t2s_2(1, 1) * t2_2(2, 1)
                     + t2s_2(1, 2) * t2_2(2, 2)),
                "T2s(i,k)*T2(j,k)(1,2)");
  test_for_zero(t2_1(2, 0)
                  - (t2s_2(2, 0) * t2_2(0, 0) + t2s_2(2, 1) * t2_2(0, 1)
                     + t2s_2(2, 2) * t2_2(0, 2)),
                "T2s(i,k)*T2(j,k)(2,0)");
  test_for_zero(t2_1(2, 1)
                  - (t2s_2(2, 0) * t2_2(1, 0) + t2s_2(2, 1) * t2_2(1, 1)
                     + t2s_2(2, 2) * t2_2(1, 2)),
                "T2s(i,k)*T2(j,k)(2,1)");
  test_for_zero(t2_1(2, 2)
                  - (t2s_2(2, 0) * t2_2(2, 0) + t2s_2(2, 1) * t2_2(2, 1)
                     + t2s_2(2, 2) * t2_2(2, 2)),
                "T2s(i,k)*T2(j,k)(2,2)");
