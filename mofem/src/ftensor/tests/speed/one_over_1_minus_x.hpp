...
inline void
func6(Tensor1<double, 3> &y, Tensor1<double, 3> &a1, Tensor1<double, 3> &a2,
      Tensor1<double, 3> &a3, Tensor1<double, 3> &a4, Tensor1<double, 3> &a5,
      Tensor1<double, 3> &a6)
{
  Index<'i', 3> i;
...
inline void
func7(Tensor1<double, 3> &y, Tensor1<double, 3> &a1, Tensor1<double, 3> &a2,
      Tensor1<double, 3> &a3, Tensor1<double, 3> &a4, Tensor1<double, 3> &a5,
...
inline void
func8(Tensor1<double, 3> &y, Tensor1<double, 3> &a1, Tensor1<double, 3> &a2,
      Tensor1<double, 3> &a3, Tensor1<double, 3> &a4, Tensor1<double, 3> &a5,
      Tensor1<double, 3> &a6, Tensor1<double, 3> &a7, Tensor1<double, 3> &a8)
{
  ...
  y(i) += a1(i) + 2 * a2(i) + 3 * (a1(j) * a2(j)) * a3(i)
          ...
          + 6 * (a1(j) * a5(j)) * (a2(k) * a4(k)) * (a3(l) * a3(l)) * a6(i)
          + 7 * (a1(j) * a6(j)) * (a2(k) * a5(k)) * (a3(l) * a4(l)) * a7(i)
          + 8 * (a1(j) * a7(j)) * (a2(k) * a6(k)) * (a3(l) * a5(l))
              * (a4(m) * a4(m)) * a8(i);
  a1(i) *= 0.1;
  a2(i) *= 0.2;
  a3(i) *= 0.3;
...
inline void
func9(Tensor1<double, 3> &y, Tensor1<double, 3> &a1, Tensor1<double, 3> &a2,
      Tensor1<double, 3> &a3, Tensor1<double, 3> &a4, Tensor1<double, 3> &a5,
      Tensor1<double, 3> &a6, Tensor1<double, 3> &a7, Tensor1<double, 3> &a8,
      Tensor1<double, 3> &a9)
{
  ...
  y(i) += a1(i) + 2 * a2(i) + 3 * (a1(j) * a2(j)) * a3(i)
          ...
          + 8 * (a1(j) * a7(j)) * (a2(k) * a6(k)) * (a3(l) * a5(l))
              * (a4(m) * a4(m)) * a8(i)
          + 9 * (a1(j) * a8(j)) * (a2(k) * a7(k)) * (a3(l) * a6(l))
              * (a4(m) * a5(m)) * a9(i);
  a1(i) *= 0.1;
  a2(i) *= 0.2;
  a3(i) *= 0.3;
