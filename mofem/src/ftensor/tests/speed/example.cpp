  ...
  for(int j = 0; j < 10000000; j++)
    {
      y(i) = x(i) + n(i);
      x(i) = y(i) - n(i);
      n(i) = n(i) + (y(i) - x(i)) - (y(i) - x(i)) + (y(i) - x(i))
             - (y(i) - x(i)) + (y(i) - x(i)) - (y(i) - x(i));

      n(i) = n(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i)
             + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i)
             - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i)
             + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i)
             - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i)
             + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i)
             - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i) + y(i) - x(i)
