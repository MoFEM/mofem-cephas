...
if (base != DEMKOWICZ_JACOBI_BASE) {
  ...
  if (data.spacesOnEntities[MBEDGE].test(H1)) {
    ...
    double *h1_edge_n[12], *diff_h1_egde_n[12];
...
// MoFEMErrorCode HexPolynomialBase::getValueHdivAinsworthBase(MatrixDouble &pts) {
//   MoFEMFunctionBegin;
...
// MoFEMErrorCode
// HexPolynomialBase::getValueHcurlAinsworthBase(MatrixDouble &pts) {
//   MoFEMFunctionBegin;
