...
//   //         auto lambda = [&](boost::shared_ptr<FieldEntity> field_entity_ptr) {
//   //           MoFEMFunctionBegin;
//   //           // // CHKERR PetscPrintf(PETSC_COMM_WORLD, "field_entity_ptr->getEntFieldData().begin():  %d \n",
//   //           // //              field_entity_ptr->getEntFieldData().begin());
//   //           // // CHKERR PetscPrintf(PETSC_COMM_WORLD, "field_entity_ptr->getEntFieldData().end() - 1:  %d  \n",
//   //           // //              field_entity_ptr->getEntFieldData().end() -1);
//   //           // cerr << " field_entity_ptr->getEntFieldData().begin() "
//   //           //      << field_entity_ptr->getEntFieldData().begin()
//   //           //      << " field_entity_ptr->getEntFieldData().end()  "
//   //           //      << field_entity_ptr->getEntFieldData().end() - 1 << "\n";
...
//               // CHKERR PetscPrintf(PETSC_COMM_WORLD, "coords b:  %e \n", coords[2][2]);
//               // CHKERR PetscPrintf(PETSC_COMM_WORLD, "coords c:  %e \n", coords[2][2]);
...
//               // CHKERR PetscPrintf(PETSC_COMM_WORLD, "field_entity_ptr->getEntFieldData()[0]:  %e \n", field_entity_ptr->getEntFieldData()[0]);
//               // CHKERR PetscPrintf(PETSC_COMM_WORLD, "coord z:  %e \n", coords[2]);
//             // }
//             // field_entity_ptr->getEntFieldData()[0] = v;
//             // std::fill(field_entity_ptr->getEntFieldData().begin(),
//             //           field_entity_ptr->getEntFieldData().end(), v);
...
//           v = temp_bc->data.value1;
//           for (auto s : vecOfTimeScalingMethods) {
//             // CHKERR PetscPrintf(PETSC_COMM_WORLD, "before:  %e \n", v);
//             v *= s->getScale(fe_method_ptr->ts_t);
//             // CHKERR PetscPrintf(PETSC_COMM_WORLD, "after:  %e \n", v);
//           }
//           CHKERR fb->fieldLambdaOnEntities(lambda, field_name, &verts);
