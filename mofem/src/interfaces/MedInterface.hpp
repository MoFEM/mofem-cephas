...
struct MedInterface : public UnknownInterface {
  ...
  std::vector<int> tesssssssssssssssssssssssssssssssssssssssssssassssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssasssssss1; //
