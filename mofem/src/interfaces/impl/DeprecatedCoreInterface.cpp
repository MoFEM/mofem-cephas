...
namespace MoFEM {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::seed_ref_level_2D(
  ...
  MoFEMErrorCode DeprecatedCoreInterface::seed_ref_level_3D(const EntityHandle meshset,const BitRefLevel &bit,int verb) {
    return getInterface<BitRefManager>()->setBitRefLevelByDim(meshset,3,bit,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::seed_ref_level(const Range &ents,const BitRefLevel &bit,const bool only_tets,int verb) {
    return getInterface<BitRefManager>()->setBitRefLevel(ents,bit,only_tets,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::seed_ref_level_MESHSET(const EntityHandle meshset,const BitRefLevel &bit,int verb) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::set_field(const double val,const EntityType type,const std::string& field_name) {
    return getInterface<FieldBlas>()->setField(val,type,field_name);
  }
  MoFEMErrorCode DeprecatedCoreInterface::set_field(const double val,const EntityType type,const Range &ents,const std::string& field_name) {
    return getInterface<FieldBlas>()->setField(val,type,ents,field_name);
  }
  MoFEMErrorCode DeprecatedCoreInterface::field_scale(const double alpha,const std::string& field_name) {
    return getInterface<FieldBlas>()->fieldScale(alpha,field_name);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_adjacencies_equality(const EntityHandle from_entiti,const int to_dimension,Range &adj_entities) const {
    return getInterface<BitRefManager>()->getAdjacenciesEquality(from_entiti,to_dimension,adj_entities);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_adjacencies_any(const EntityHandle from_entiti,const int to_dimension,Range &adj_entities) const {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::VecCreateSeq(const std::string &name,RowColData rc,Vec *V) const {
    return getInterface<VecManager>()->vecCreateSeq(name,rc,V);
  }
  MoFEMErrorCode DeprecatedCoreInterface::VecCreateGhost(const std::string &name,RowColData rc,Vec *V) const {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::ISCreateFromProblemFieldToOtherProblemField(
  ...
  MoFEMErrorCode DeprecatedCoreInterface::shift_right_bit_ref(const int shift,int verb) {
    return getInterface<BitRefManager>()->shiftRightBitRef(shift,BitRefLevel().set(),verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_entities_by_type_and_ref_level(const BitRefLevel &bit,const BitRefLevel &mask,const EntityType type,const EntityHandle meshset,int verb) {
    return getInterface<BitRefManager>()->getEntitiesByTypeAndRefLevel(bit,mask,type,meshset,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_entities_by_type_and_ref_level(const BitRefLevel &bit,const BitRefLevel &mask,const EntityType type,Range &ents,int verb) {
    return getInterface<BitRefManager>()->getEntitiesByTypeAndRefLevel(bit,mask,type,ents,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_entities_by_ref_level(const BitRefLevel &bit,const BitRefLevel &mask,const EntityHandle meshset) {
    return getInterface<BitRefManager>()->getEntitiesByRefLevel(bit,mask,meshset);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_entities_by_ref_level(const BitRefLevel &bit,const BitRefLevel &mask,Range &ents) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::update_field_meshset_by_entities_children(const BitRefLevel &child_bit,int verb) {
    return getInterface<BitRefManager>()->updateFieldMeshsetByEntitiesChildren(child_bit,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::update_field_meshset_by_entities_children(const std::string name,const BitRefLevel &child_bit,int verb) {
    return getInterface<BitRefManager>()->updateFieldMeshsetByEntitiesChildren(name,child_bit,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::update_finite_element_meshset_by_entities_children(const std::string name,const BitRefLevel &child_bit,const EntityType fe_ent_type,int verb) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::add_cubit_msId(const CubitBCType cubit_bc_type,const int ms_id,const std::string name) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::set_cubit_msId_attribites_data_structure(
  ...
  MoFEMErrorCode DeprecatedCoreInterface::delete_cubit_msId(const CubitBCType cubit_bc_type,const int ms_id) {
    return getInterface<MeshsetsManager>()->deleteMeshset(cubit_bc_type,ms_id);
  }
  MoFEMErrorCode DeprecatedCoreInterface::get_cubit_msId(const int ms_id,const CubitBCType cubit_bc_type,const CubitMeshSets **cubit_meshset_ptr) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::get_cubit_msId_entities_by_dimension(const int msId,const CubitBCType cubit_bc_type,Range &entities,const bool recursive) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::get_cubit_msId_meshset(const int ms_id,const unsigned int cubit_bc_type,EntityHandle &meshset) {
    return getInterface<MeshsetsManager>()->getMeshset(ms_id,cubit_bc_type,meshset);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_cubit_meshsets(const unsigned int cubit_bc_type,Range &meshsets) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::build_problem(Problem *problem_ptr,const bool square_matrix,int verb) {
    return getInterface<ProblemsManager>()->buildProblem(problem_ptr,square_matrix,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::build_problem(const std::string &problem_name,const bool square_matrix,int verb) {
    return getInterface<ProblemsManager>()->buildProblem(problem_name,square_matrix,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::partition_simple_problem(const std::string &name,int verb) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::partition_problem(const std::string &name,int verb) {
  ...
  MoFEMErrorCode DeprecatedCoreInterface::partition_ghost_dofs(const std::string &name,int verb) {
    return getInterface<ProblemsManager>()->partitionGhostDofs(name,verb);
  }

  MoFEMErrorCode DeprecatedCoreInterface::get_problem_elements_layout(const std::string &name,const std::string &fe_name,PetscLayout *layout,int verb) {
    return getInterface<ProblemsManager>()->getProblemElementsLayout(name,fe_name,layout);
  }

  MoFEMErrorCode DeprecatedCoreInterface::partition_mesh(
