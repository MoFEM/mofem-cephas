...
struct Tools : public UnknownInterface {
  ...
  static constexpr double diffShapeFunMBHEX0x =
      diffN_MBHEX0x(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX0y =
      diffN_MBHEX0y(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX0z =
      diffN_MBHEX0z(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX1x =
      diffN_MBHEX1x(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX1y =
      diffN_MBHEX1y(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX1z =
      diffN_MBHEX1z(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX2x =
      diffN_MBHEX2x(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX2y =
      diffN_MBHEX2y(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX2z =
      diffN_MBHEX2z(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX3x =
      diffN_MBHEX3x(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX3y =
      diffN_MBHEX3y(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX3z =
      diffN_MBHEX3z(0., 1.); ///< derivative of tetrahedral shape function

  static constexpr double diffShapeFunMBHEX4x =
      diffN_MBHEX4x(0., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX4y =
      diffN_MBHEX4y(0., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX4z =
      diffN_MBHEX4z(0., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX5x =
      diffN_MBHEX5x(0., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX5y =
      diffN_MBHEX5y(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX5z =
      diffN_MBHEX5z(1., 0.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX6x =
      diffN_MBHEX6x(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX6y =
      diffN_MBHEX6y(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX6z =
      diffN_MBHEX6z(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX7x =
      diffN_MBHEX7x(1., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX7y =
      diffN_MBHEX7y(0., 1.); ///< derivative of tetrahedral shape function
  static constexpr double diffShapeFunMBHEX7z =
      diffN_MBHEX7z(0., 1.); ///< derivative of tetrahedral shape function

  static inline double shapeFunMBHEX0(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX1(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX2(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX3(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX4(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX5(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX6(const double x, const double y,
                                      const double z);

  static inline double shapeFunMBHEX7(const double x, const double y,
                                      const double z);

  static constexpr std::array<double, 24> diffShapeFunMBHEX = {

      diffShapeFunMBHEX0x, diffShapeFunMBHEX0y, diffShapeFunMBHEX0z,

      diffShapeFunMBHEX1x, diffShapeFunMBHEX1y, diffShapeFunMBHEX1z,

      diffShapeFunMBHEX2x, diffShapeFunMBHEX2y, diffShapeFunMBHEX2z,

      diffShapeFunMBHEX3x, diffShapeFunMBHEX3y, diffShapeFunMBHEX3z,

      diffShapeFunMBHEX4x, diffShapeFunMBHEX4y, diffShapeFunMBHEX4z,

      diffShapeFunMBHEX5x, diffShapeFunMBHEX5y, diffShapeFunMBHEX5z,

      diffShapeFunMBHEX6x, diffShapeFunMBHEX6y, diffShapeFunMBHEX6z,

      diffShapeFunMBHEX7x, diffShapeFunMBHEX7y, diffShapeFunMBHEX7z};

/**
   * @brief Calculate shape functions on hexahedron
   *
   * \note Template parameter is leading dimension of point coordinate arrays,
   * such that \f$ksi_{n+1} = ksi[n + LDB]\f$
   *
   ...
   */
  template <int LDB = 1>
  static MoFEMErrorCode shapeFunMBHEX(double *shape, const double *ksi,
  ...
  static constexpr double shapeFunMBHEX0At000 = N_MBHEX0(0, 0, 0);
  static constexpr double shapeFunMBHEX1At000 = N_MBHEX1(0, 0, 0);
  static constexpr double shapeFunMBHEX2At000 = N_MBHEX2(0, 0, 0);
  static constexpr double shapeFunMBHEX3At000 = N_MBHEX3(0, 0, 0);
  static constexpr double shapeFunMBHEX4At000 = N_MBHEX4(0, 0, 0);
  static constexpr double shapeFunMBHEX5At000 = N_MBHEX5(0, 0, 0);
  static constexpr double shapeFunMBHEX6At000 = N_MBHEX6(0, 0, 0);
  static constexpr double shapeFunMBHEX7At000 = N_MBHEX7(0, 0, 0);
   ...
   *
   */
  static constexpr std::array<double, 8> shapeFunMBHEXAt000 = {
      shapeFunMBHEX0At000, shapeFunMBHEX1At000, shapeFunMBHEX2At000,
      shapeFunMBHEX3At000, shapeFunMBHEX4At000, shapeFunMBHEX5At000,
      shapeFunMBHEX6At000, shapeFunMBHEX7At000};
   ...
   * @return MoFEMErrorCode
   */
  static MoFEMErrorCode getLocalCoordinatesOnReferenceEightNodeHex(
      const double *elem_coords, const double *glob_coords, const int nb_nodes,
      double *local_coords);
...
double Tools::shapeFunMBHEX0(const double x, const double y, const double z) {
  return N_MBHEX0(x, y, z);
}

double Tools::shapeFunMBHEX1(const double x, const double y, const double z) {
  return N_MBHEX1(x, y, z);
}

double Tools::shapeFunMBHEX2(const double x, const double y, const double z) {
  return N_MBHEX2(x, y, z);
}

double Tools::shapeFunMBHEX3(const double x, const double y, const double z) {
  return N_MBHEX3(x, y, z);
};

double Tools::shapeFunMBHEX4(const double x, const double y, const double z) {
  return N_MBHEX4(x, y, z);
}

double Tools::shapeFunMBHEX5(const double x, const double y, const double z) {
  return N_MBHEX5(x, y, z);
}

double Tools::shapeFunMBHEX6(const double x, const double y, const double z) {
  return N_MBHEX6(x, y, z);
}

double Tools::shapeFunMBHEX7(const double x, const double y, const double z) {
  return N_MBHEX7(x, y, z);
};


template <int LDB>
MoFEMErrorCode Tools::shapeFunMBHEX(double *shape, const double *ksi,
                                    const double *eta, const double *zeta,
                                    const double nb) {
  MoFEMFunctionBeginHot;
  for (int n = 0; n != nb; ++n) {
    shape[0] = shapeFunMBHEX0(*ksi, *eta, *zeta);
    shape[1] = shapeFunMBHEX1(*ksi, *eta, *zeta);
    shape[2] = shapeFunMBHEX2(*ksi, *eta, *zeta);
    shape[3] = shapeFunMBHEX3(*ksi, *eta, *zeta);
    shape[4] = shapeFunMBHEX4(*ksi, *eta, *zeta);
    shape[5] = shapeFunMBHEX5(*ksi, *eta, *zeta);
    shape[6] = shapeFunMBHEX6(*ksi, *eta, *zeta);
    shape[7] = shapeFunMBHEX7(*ksi, *eta, *zeta);
    shape += 8;
    ksi += LDB;
    eta += LDB;
    zeta += LDB;
