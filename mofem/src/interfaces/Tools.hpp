...
namespace MoFEM {
  ...
  struct Tools: public UnknownInterface {
    ...
    static inline double nMBTET0(const double x, const double y,
                                 const double z) {
      return N_MBTET0(x, y, z);
    }

    static inline double nMBTET1(const double x, const double y,
                                 const double z) {
      return N_MBTET1(x, y, z);
    }

    static inline double nMBTET2(const double x, const double y,
                                 const double z) {
      return N_MBTET2(x, y, z);
    }

    static inline double nMBTET3(const double x, const double y,
                                 const double z) {
    ...
    static MoFEMErrorCode getLocalCoordinatesOnReferenceFourNodeTet(
        const double *elem_coords, const double *glob_coords,
        const int nb_nodes, double *local_coords);
