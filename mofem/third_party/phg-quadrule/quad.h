...
typedef struct QUAD_ {
    ...
    double *points;		/* barycentric coordinates of quad. points */
    double *weights;		/* weights */
    char id;			/* id (for use with reference count) */
} QUAD;
...
static QUAD *QUAD_1D_TABLE[] = { QUAD_1D_P1,
...
static QUAD *QUAD_2D_TABLE[] = { QUAD_2D_P1,
...
static QUAD *QUAD_3D_TABLE[] = { QUAD_3D_P1,
