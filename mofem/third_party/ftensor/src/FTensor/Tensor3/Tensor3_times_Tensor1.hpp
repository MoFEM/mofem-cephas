...
class Tensor3_times_Tensor1
{
  const Tensor3_Expr<A,T,Dim0,Dim1,Dim2,i,j,k> iterA;
  const Tensor1_Expr<B,U,Dim3,l> iterB;
public:
  Tensor3_times_Tensor1(const Tensor3_Expr<A,T,Dim0,Dim1,Dim2,i,j,k> &a,const Tensor1_Expr<B,U,Dim3,l> &b)
  : iterA(a), iterB(b) {}
...
inline Tensor4_Expr <const Tensor3_times_Tensor1<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l>,typename promote<T,U>::V,Dim0,Dim1,Dim2,Dim3,i,j,k,l>
operator*(const Tensor3_Expr<A,T,Dim0,Dim1,Dim2,i,j,k> &a, const Tensor1_Expr<B,U,Dim3,l> &b)
{
  typedef const Tensor3_times_Tensor1<A,B,T,U,Dim0,Dim1,Dim2,Dim3,i,j,k,l> TensorExpr;
