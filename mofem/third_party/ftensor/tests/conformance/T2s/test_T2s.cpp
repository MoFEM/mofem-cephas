...
void test_T2s_03(const Tensor2<double,3,3> &t2_2,
                 Tensor2_symmetric<double,3> &t2s_1);
void test_T2s_04(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 Tensor2_symmetric<double,3> &t2s_1);
...
void test_T2s_29(Tensor2_symmetric<double,3> &t2s_1,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_30(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_31(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_32(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_33(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
...
void test_T2s_36(const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_37(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_38(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_39(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
void test_T2s_40(Tensor2<double,3,3> &t2_1, const Tensor2<double,3,3> &t2_2,
                 const Tensor2_symmetric<double,3> &t2s_2);
