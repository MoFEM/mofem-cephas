...
if(WITH_TETGEN)
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND cmake ${PROJECT_BINARY_DIR}/external/src/tetgen/tetgen1.5.0
    BUILD_COMMAND make
    INSTALL_COMMAND ""
  )
  ...
  add_custom_target(
    copy_tetgen_fields
    ALL
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BINARY_DIR}/external/src/tetgen/tetgen1.5.0/include/tetgen.h ${PROJECT_BINARY_DIR}/external/include
