set(CTEST_BUILD_OPTIONS "-DSTAND_ALLONE_USERS_MODULES=ON")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_OBSOLETE=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_HOMOGENISATION=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_FRACTURE_MECHANICS=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_GELS=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_STRAIN_PLASTICITY=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_SOLID_SHELL_PRISM_ELEMENT=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_MINIMAL_SURFACE_EQUATION=1")
list(APPEND CTEST_BUILD_OPTIONS "-DWITH_MODULE_MINIMAL_HELMHOLTZ=1")
