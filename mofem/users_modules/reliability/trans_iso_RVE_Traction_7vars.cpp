 ...
 * homogenization problem under constant traction boundary condition by
...
//    std::cin >> wait;
  ...
  //----------------------------------------------------------------------------
    ...
    //Save data on mesh set_global_ghost_vector
...
//    ierr = VecView(D,PETSC_VIEWER_STDOUT_WORLD); CHKERRQ(ierr);
  ...
  ElasticFE_RVELagrange_Homogenized_Stress_Traction MyFE_RVEHomoStressTraction_r(mField,Aij,D,F,&RVE_volume, applied_strain, Stress_Homo_r,"DISPLACEMENT","Lagrange_mul_disp",field_rank);
