...
namespace MoFEM {
  ...
  struct Trans_Iso_Rhs_r_PSFEM: public TranIsotropicFibreDirRotElasticFEMethod_PSFE {
    ...
    TranIsotropicFibreDirRotElasticFEMethod_PSFE(_mField,_Aij,_D,_F,_zeroth_field),
