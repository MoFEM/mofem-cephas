...
namespace MoFEM {
  ...
  struct _FE2_Macro_Solver_Laminate {
    ...
    PetscErrorCode Micro_FE_Dmat(FieldInterface &m_field_RVE,
      ...
      TranIsotropicFibreDirRotElasticFEMethod_PSFE MyTIsotFE(m_field_RVE,Aij,D1,F1,"DISP_RVE");
      ...
      ierr = VecDestroy(&Stress_Homo_rs); CHKERRQ(ierr);
