...
#ifndef __FE2_RHS_R_PSFEM_DEGRADATION_HPP__
#define __FE2_RHS_R_PSFEM_DEGRADATION_HPP__

using namespace ObosleteUsersModules;

namespace MoFEM {
  
  struct FE2_Rhs_r_PSFEM_Degradation: public ElasticFEMethod {
    
    map<EntityHandle, ublas::vector<ublas::matrix<double> > > &Dmat_RVE_r;
    Vec dF;
    string zeroth_field;
    FE2_Rhs_r_PSFEM_Degradation(FieldInterface& _mField,
                    Mat &_A,
                    Vec _D,
                    Vec _F,
                    map<EntityHandle, ublas::vector<ublas::matrix<double> > > &_Dmat_RVE_r,
                    string _field_name):
    ElasticFEMethod(_mField,
                    _A,
                    _D,
                    _F,
                    0.0,
                    0.0,
                    _field_name),dF(_F),Dmat_RVE_r(_Dmat_RVE_r),zeroth_field(_field_name){};
...
#endif //__FE2_RHS_R_PSFEM_DEGRADATION_HPP__
