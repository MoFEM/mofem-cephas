...
namespace MoFEM {
  ...
  struct Trans_Iso_Rhs_rs_PSFEM: public TranIsotropicFibreDirRotElasticFEMethod_PSFE {
    ...
    TranIsotropicFibreDirRotElasticFEMethod_PSFE(_mField,_Aij,_D,_F,_zeroth_field),ddF(_F),zeroth_field(_zeroth_field),first_field(_first_field),ix_first_randvar(_ix_first_randvar),ix_second_randvar(_ix_second_randvar),material_type(_material_type),material_function(_material_function){};
