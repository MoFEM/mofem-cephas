...
int main(int argc, char *argv[]) {
  ...
  ierr = moab.get_connectivity(tets_skin,tets_skin_nodes,true); CHKERRG(ierr);
  ierr = m_field.add_ents_to_finite_element_by_type(tets_skin_nodes,MBVERTEX,"TEST_FE"); CHKERRG(ierr);
