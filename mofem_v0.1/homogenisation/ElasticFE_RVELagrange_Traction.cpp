...
namespace MoFEM {
  ...
  PetscErrorCode ElasticFE_RVELagrange_Traction::GetN_and_Indices() {
      PetscFunctionBegin;
...
//        std::cin >> wait;
    ...
    PetscErrorCode ElasticFE_RVELagrange_Traction::Get_H_mat() {
      PetscFunctionBegin;
      ...
      const EntityHandle *conn_face;
      int num_nodes_face;
      rval = moab.get_connectivity(fePtr->get_ent(),conn_face,num_nodes_face,true); CHKERR_PETSC(rval);
...
//            cout<<"H_mat[rrr] "<<H_mat[rrr]<<endl;
    ...
    PetscErrorCode ElasticFE_RVELagrange_Traction::Stiffness() {
      PetscFunctionBegin;
      //        cout<<" row_mat; "<<row_mat<<endl;
    ...
    PetscErrorCode ElasticFE_RVELagrange_Traction::Lhs() {
      PetscFunctionBegin;
    ...
    PetscErrorCode ElasticFE_RVELagrange_Traction::operator()() {
      PetscFunctionBegin;
