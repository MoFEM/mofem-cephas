...
namespace MoFEM {
  ...
  struct ElasticFE_RVELagrange_Disp_Transport: public FEMethod_UpLevelStudent {
...
//      G_W_TRI = G_TRI_W28;
      ...
      unsigned int gg1=0;
      for(unsigned int gg = 0;gg<g_TRI_dim;gg++) {
...
//        cout<<"rowNMatrices[row_mat][gg] "<<rowNMatrices[row_mat][gg]<<endl;
//      }
...
//      cout<<" area = "<<area<<endl;
      ...
      for(;nn<3;nn++) {
        ...
        niit = row_multiIndex->get<Composite_Name_And_Ent_mi_tag>().lower_bound(boost::make_tuple("Lagrange_mul_conc",conn_face[nn]));
        hi_niit = row_multiIndex->get<Composite_Name_And_Ent_mi_tag>().upper_bound(boost::make_tuple("Lagrange_mul_conc",conn_face[nn]));
        col_niit = col_multiIndex->get<Composite_Name_And_Ent_mi_tag>().lower_bound(boost::make_tuple("CONCENTRATION",conn_face[nn]));
        hi_col_niit = col_multiIndex->get<Composite_Name_And_Ent_mi_tag>().upper_bound(boost::make_tuple("CONCENTRATION",conn_face[nn]));
...
//        cout<<"edge "<<edge<<endl;
        eiit = row_multiIndex->get<Composite_Name_And_Ent_mi_tag>().lower_bound(boost::make_tuple("Lagrange_mul_conc",edge));
        hi_eiit = row_multiIndex->get<Composite_Name_And_Ent_mi_tag>().upper_bound(boost::make_tuple("Lagrange_mul_conc",edge));
        
        col_eiit = col_multiIndex->get<Composite_Name_And_Ent_mi_tag>().lower_bound(boost::make_tuple("CONCENTRATION",edge));
        col_hi_eiit = col_multiIndex->get<Composite_Name_And_Ent_mi_tag>().upper_bound(boost::make_tuple("CONCENTRATION",edge));
...
//                cout<<"jj  "<<jj<<endl;
//
//                rowNMatrices[row_mat1][gg](1,ii)=N_edge[ee][gg1]; gg1++;
//              }
//            }
          }
