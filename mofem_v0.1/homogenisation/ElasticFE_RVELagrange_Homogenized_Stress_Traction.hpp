...
namespace MoFEM {
    ...
    struct ElasticFE_RVELagrange_Homogenized_Stress_Traction: public ElasticFE_RVELagrange_Traction{
        ...
        ElasticFE_RVELagrange_Homogenized_Stress_Traction(FieldInterface& _mField,BaseDirihletBC *_dirihlet_ptr,Mat &_Aij,Vec &_D,Vec& _F,double *_RVE_volume):
        ElasticFE_RVELagrange_Traction(_mField, _dirihlet_ptr,_Aij, _D, _F), DVec(_D),RVE_volume(_RVE_volume){};
