...
#ifndef __K_RS_YOUNG_PSFEMETHOD_HPP__
#define __K_RS_YOUNG_PSFEMETHOD_HPP__
...
struct K_rs_Young_PSFEMethod: public K_rs_PSFEMethod {

    K_rs_Young_PSFEMethod( FieldInterface& _mField,Mat &_Aij,Vec _X,Vec _F,double _young,double _pois,const string& _second_field):
...
#endif //__K_RS_YOUNG_PSFEMETHOD_HPP__
