...
int main(int argc, char *argv[]) {
  ...
  //============================================================================================================================
  //RVE volume for homogenized stress calculation
...
//  ierr = VecView(dD,PETSC_VIEWER_STDOUT_WORLD); CHKERRQ(ierr);
  ...
  //    ierr = VecView(D,PETSC_VIEWER_STDOUT_WORLD); CHKERRQ(ierr);
  ElasticFE_RVELagrange_Homogenized_Stress_Periodic MyFE_RVEHomoStressPeriodic_rs(mField,Aij,D,F,&RVE_volume,applied_strain,Stress_Homo_rs,"DISPLACEMENT","Lagrange_mul_disp",field_rank);
  ierr = mField.loop_finite_elements("STOCHASIC_PROBLEM","Lagrange_elem",MyFE_RVEHomoStressPeriodic_rs);  CHKERRQ(ierr);
