...
#ifndef __K_R_YOUNG_PSFEMETHOD_HPP__
#define __K_R_YOUNG_PSFEMETHOD_HPP__
...
namespace MoFEM {
  ...
  struct K_r_Young_PSFEMethod: public K_r_PSFEMethod {

    K_r_Young_PSFEMethod( FieldInterface& _mField,Mat &_Aij,Vec _X,Vec _F,double _young,double _pois):
...
#endif //__K_R_YOUNG_PSFEMETHOD_HPP__
