...
struct MoFEMEntityEntMoFEMFiniteElementAdjacencyMap {
  ...
  inline LocalUId get_MoFEMFiniteElement_unique_id() const { return EntMoFEMFiniteElement_ptr->get_unique_id(); }
  ...
  inline LocalUId get_ent_unique_id() const { return MoFEMEntity_ptr->get_unique_id(); };
 ...
 * \param    hashed_unique< tag<Composite_unique_mi_tag>, <br>
	...
	const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_ent_unique_id>, <br>
	const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_MoFEMFiniteElement_unique_id> > >, <br>
 * \param    ordered_non_unique<
      tag<Unique_mi_tag>, const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_ent_unique_id> >
 *
 */
typedef multi_index_container<
  ...
  indexed_by<
    ordered_unique<
      ...
      composite_key<
	MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,
	const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_ent_unique_id>,
	const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_MoFEMFiniteElement_unique_id> > >,
    ordered_non_unique<
      tag<Unique_mi_tag>, const_mem_fun<MoFEMEntityEntMoFEMFiniteElementAdjacencyMap,LocalUId,&MoFEMEntityEntMoFEMFiniteElementAdjacencyMap::get_ent_unique_id> >,
    ordered_non_unique<
