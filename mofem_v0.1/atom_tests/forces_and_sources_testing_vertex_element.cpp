...
int main(int argc, char *argv[]) {
  ...
  VertexElementForcesAndSurcesCore fe1(mField);
  ...
  struct MyOp: public VertexElementForcesAndSurcesCore::UserDataOperator {

    TeeStream &my_split;
    MyOp(TeeStream &_my_split):
      VertexElementForcesAndSurcesCore::UserDataOperator("FIELD1","FIELD1"),
      my_split(_my_split) {}
