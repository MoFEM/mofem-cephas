...
#define __ElasticFE_RVELagrange_RigidBodyRotation__
...
struct ElasticFE_RVELagrange_RigidBodyRotation: public ElasticFE_RVELagrange_Disp {
    ...
    ElasticFE_RVELagrange_RigidBodyRotation(FieldInterface& _mField,BaseDirihletBC *_dirihlet_ptr,Mat &_Aij,Vec &_D,Vec& _F):
