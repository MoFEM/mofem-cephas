...
struct PostProcDisplacemenysAndStarinAndElasticLinearStressOnRefMesh: public PostProcDisplacemenysAndStarinOnRefMesh {
  ...
  PostProcDisplacemenysAndStarinAndElasticLinearStressOnRefMesh(
    Interface& _moab,FieldInterface& _mField, string _field_name,double _lambda,double _mu): PostProcDisplacemenysAndStarinOnRefMesh(_moab,_field_name),lambda(_lambda),mu(_mu), mField(_mField) {
