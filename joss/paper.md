...
# Introduction and Motivation
 ...
 capabilities. A more elegant approach was paved by @babuska1992version, 
...
# Design
 ...
 [@MoFEMWebPage].\label{fig:design}](basic_design.pdf){width=100%}
  ...
  ensured since the underpinning components have sustainable funding, dynamic
...
# Examples and Capabilities
 ...
 applied to the Scordelis-Lo perforated roof problem [@kaczmarczyk2016prism]. 
  ...
  bases, e.g. bubble base of zero normal and divergence-free base
  ...
  snippet below, we outline defining approximation space, base and order for each
...
# Conclusions 
 ...
 `MoFEM` introduces a novel architecture of FEM software, designed to exploit advantages
