...
//  }
      ...
      ierr = mField.get_msId_meshset(1,BlockSet,meshset_BlockSet2); CHKERRQ(ierr);

      rval = moab.write_file("checkmesh.vtk","VTK","",&meshset_BlockSet2,1); CHKERR_PETSC(rval);
