...
struct ArcInterfaceFEMethod: public InterfaceFEMethod {
  ...
  ArcInterfaceFEMethod(
      ...
      Range &_SideSet1,Range &_SideSet2,interface_materials_context _int_mat_ctx = ctx_IntLinearSoftening): 
      InterfaceFEMethod(_moab,_dirihlet_ptr,_Aij,_F,_YoungModulus,_SideSet1,_SideSet2),int_mat_ctx(_int_mat_ctx),
