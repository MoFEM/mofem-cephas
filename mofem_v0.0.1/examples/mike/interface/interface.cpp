...
struct MyElasticFEMethod: public InterfaceElasticFEMethod {
    ...
    MyElasticFEMethod(Interface& _moab): InterfaceElasticFEMethod(_moab) {};
    ...
    InterfaceElasticFEMethod(_moab,_dirihlet_ptr,_Aij,_F,_lambda,_mu,_SideSet1,_SideSet2) {};
    ...
    PetscErrorCode ApplyDirihletBC() {
        ...
        for(;siit1!=SideSet1_.end();siit1++,iter++) {
