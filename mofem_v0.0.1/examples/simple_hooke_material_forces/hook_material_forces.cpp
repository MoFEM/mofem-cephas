...
int main(int argc, char *argv[]) {
  ...
  ierr = MatAssemblyBegin(C_ALL,MAT_FLUSH_ASSEMBLY); CHKERRQ(ierr);
  ierr = MatAssemblyEnd(C_ALL,MAT_FLUSH_ASSEMBLY); CHKERRQ(ierr);
  ...
  ierr = proj_all_ctx.Destroy(); CHKERRQ(ierr);
