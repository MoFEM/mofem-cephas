...
struct InterfaceElasticFEMethod: public ElasticFEMethod {
  ...
  InterfaceElasticFEMethod(Interface& _moab): ElasticFEMethod(_moab) {};
  ...
  InterfaceElasticFEMethod(
      ...
      ElasticFEMethod(_moab,_dirihlet_ptr,_Aij,_F,_lambda,_mu,_SideSet1,_SideSet2) {};
...
struct InterfaceFEMethod: public InterfaceElasticFEMethod {
  ...
  InterfaceFEMethod(
      Interface& _moab,BaseDirihletBC *_dirihlet_ptr,Mat &_Aij,Vec& _F,double _YoungModulus,Range &_SideSet1,Range &_SideSet2): 
	InterfaceElasticFEMethod(_moab,_dirihlet_ptr,_Aij,_F,0,0,_SideSet1,_SideSet2),YoungModulus(_YoungModulus) {
    DispData.resize(1+6+2);
    };
