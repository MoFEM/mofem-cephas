...
int main(int argc, char *argv[]) {
  ...
  ierr = mField.modify_finite_element_add_field_data("ELASTIC","DISPLACEMENT"); CHKERRQ(ierr);
                ...
                ierr = mField.modify_finite_element_add_field_row("ELASTIC","Lagrange_mul_disp"); CHKERRQ(ierr);
                ierr = mField.modify_finite_element_add_field_col("ELASTIC","Lagrange_mul_disp"); CHKERRQ(ierr);
                ierr = mField.modify_finite_element_add_field_data("ELASTIC","Lagrange_mul_disp"); CHKERRQ(ierr);
  ...
  ierr = mField.add_ents_to_field_by_TETs(0,"DISPLACEMENT"); CHKERRQ(ierr);
    ...
    ierr = mField.seed_finite_elements(SurfacesFaces); CHKERRQ(ierr);
                ...
                ierr = mField.add_ents_to_field_by_TRIs(0,"Lagrange_mul_disp"); CHKERRQ(ierr);
